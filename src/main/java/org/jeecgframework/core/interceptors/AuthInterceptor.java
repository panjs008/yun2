...
public class AuthInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		if(requestPath.contains("emailController.do") ||requestPath.contains("eSmsRecordController.do")||requestPath.contains("loginController.do?loginForEmail") || requestPath.contains("userController.do?saveUserForReg")  ||requestPath.contains("ymkCustomController.do") || requestPath.contains("duplicateCheckAction.do?doDuplicateCheck")){
			return true;
		}
