...
public class ChooseTag extends TagSupport {
	...
	public StringBuffer end() {
		...
		if (this.url.contains("emkProductController.do?proSelect") || this.url.contains("emkStorageController.do?proSelect")  || this.url.contains("emkStorageController.do?proSelectForCustom")) {
		...
		} else if (this.url.contains("emkProductPriceController.do?select")) {
			sb.append("<a href=\"#\" id=\"chkInfoForPrice\" class=\"easyui-linkbutton\" plain=\"true\" icon=\"" + this.icon + "\" onClick=\"choose_" + methodname + StringUtil.replace("()\">{0}</a>", "{0}", MutiLangUtil.getMutiLangInstance().getLang("common.select", this.langArg)));
		} else if (this.url.contains("emkProductController.do?proForOne")) {
			sb.append("<a href=\"#\" id=\"chkInfoForOne\" class=\"easyui-linkbutton\" plain=\"true\" icon=\"" + this.icon + "\" onClick=\"choose_" + methodname + StringUtil.replace("()\">{0}</a>", "{0}", MutiLangUtil.getMutiLangInstance().getLang("common.select", this.langArg)));
		}else {
		...
		/*sb.append("<a href=\"#\" id=\"chkInfo\" class=\"easyui-linkbutton\" plain=\"true\" icon=\"" + icon + "\" onClick=\"choose_"+methodname+ StringUtil.replace("()\">{0}</a>", "{0}", MutiLangUtil.getMutiLangInstance().getLang("common.select", langArg)));
	...
	private void callback(StringBuffer sb,String methodname) {
		...
		if (this.url.contains("emkProductController.do?proForOne")) {
			sb.append("returnToOneVal();");
		}
		if (this.url.contains("userController.do?userOwner")) {
			sb.append("returnToVal0();");
		}
		if (this.url.contains("emkProductPriceController.do?select")) {
			sb.append("returnToPriceVal();");
		}
