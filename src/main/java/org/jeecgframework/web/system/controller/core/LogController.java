...
public class LogController extends BaseController {
	...
	public void datagrid(HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid,TSLog tsLog) {
		...
		HqlGenerateUtil.installHql(cq, tsLog, request.getParameterMap());
