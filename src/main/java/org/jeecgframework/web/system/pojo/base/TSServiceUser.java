...
public class TSServiceUser extends TSBaseUser implements java.io.Serializable {
	...
	@Formula("(SELECT t1.contact_id FROM ymk_custom_contact_user t1 WHERE t1.user_id=id)")
