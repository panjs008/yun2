package com.hm.rsgl.basesalary.service.impl;
...
@Service("hmBaseSalaryService")
@Transactional
public class HmBaseSalaryServiceImpl extends CommonServiceImpl implements HmBaseSalaryServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(HmBaseSalaryEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(HmBaseSalaryEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(HmBaseSalaryEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(HmBaseSalaryEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,HmBaseSalaryEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("hm_base_salary",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
