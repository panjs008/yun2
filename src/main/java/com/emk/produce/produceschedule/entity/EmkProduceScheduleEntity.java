...
public class EmkProduceScheduleEntity implements java.io.Serializable {
	...
	@Column(name ="product_ht_num",nullable=true,length=50)
	public String getProductHtNum() {
		return productHtNum;
	}

	public void setProductHtNum(String productHtNum) {
		this.productHtNum = productHtNum;
	}
	/**
	 *方法: 取得String
	 *@return: String  提交日期
