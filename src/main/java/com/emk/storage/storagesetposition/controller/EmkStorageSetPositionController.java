...
public class EmkStorageSetPositionController
    ...
    public AjaxJson doDel(EmkStorageSetPositionEntity emkStorageSetPosition, HttpServletRequest request) {
        ...
        emkStorageSetPosition = systemService.getEntity(EmkStorageSetPositionEntity.class, emkStorageSetPosition.getId());
        message = "库位表删除成功";
        try {
    ...
    public AjaxJson doBatchDel(String ids, HttpServletRequest request) {
        ...
        try {
            for (String id : ids.split(",")) {
                EmkStorageSetPositionEntity emkStorageSetPosition = systemService.getEntity(EmkStorageSetPositionEntity.class, id);
                this.emkStorageSetPositionService.delete(emkStorageSetPosition);
                this.systemService.addLog(message, Globals.Log_Type_DEL, Globals.Log_Leavel_INFO);
            }
        } catch (Exception e) {
    ...
    public AjaxJson doAdd(EmkStorageSetPositionEntity emkStorageSetPosition, HttpServletRequest request) {
        ...
        try {
            ...
            emkStorageSetPosition.setOrgCode(tsDepart.getOrgCode());
            emkStorageSetPosition.setDepartId(tsDepart.getId());
    ...
    public AjaxJson doUpdate(EmkStorageSetPositionEntity emkStorageSetPosition, HttpServletRequest request) {
        ...
        AjaxJson j = new AjaxJson();
        message = "库位表更新成功";
        EmkStorageSetPositionEntity t = emkStorageSetPositionService.get(EmkStorageSetPositionEntity.class, emkStorageSetPosition.getId());
        try {
    ...
    public ModelAndView goAdd(EmkStorageSetPositionEntity emkStorageSetPosition, HttpServletRequest req) {
        if (StringUtil.isNotEmpty(emkStorageSetPosition.getId())) {
            emkStorageSetPosition = emkStorageSetPositionService.getEntity(EmkStorageSetPositionEntity.class, emkStorageSetPosition.getId());
    ...
    public ResponseMessage<?> get(@ApiParam(required = true, name = "id", value = "ID") @PathVariable("id") String id) {
        EmkStorageSetPositionEntity task = emkStorageSetPositionService.get(EmkStorageSetPositionEntity.class, id);
        if (task == null) {
