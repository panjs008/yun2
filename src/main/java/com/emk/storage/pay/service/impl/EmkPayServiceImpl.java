package com.emk.storage.pay.service.impl;
...
@Service("emkPayService")
@Transactional
public class EmkPayServiceImpl extends CommonServiceImpl implements EmkPayServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(EmkPayEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(EmkPayEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(EmkPayEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(EmkPayEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,EmkPayEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("emk_pay",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
