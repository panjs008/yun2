package com.emk.storage.outorder.service.impl;
...
@Service("emkOutOrderService")
@Transactional
public class EmkOutOrderServiceImpl extends CommonServiceImpl implements EmkOutOrderServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(EmkOutOrderEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(EmkOutOrderEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(EmkOutOrderEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(EmkOutOrderEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,EmkOutOrderEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("emk_out_order",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
