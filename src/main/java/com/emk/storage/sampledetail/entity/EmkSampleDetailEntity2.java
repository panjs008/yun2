...
public class EmkSampleDetailEntity2 implements Serializable {
    private String id;
    ...
    @Formula("(select t2.typename from t_s_type t2 left join t_s_typegroup t1 on t1.ID=t2.typegroupid where t1.typegroupcode='color' and t2.typecode=color limit 0,1)")
