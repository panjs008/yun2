...
public class EmkSizeTotalEntityJ implements java.io.Serializable {
	/**主键*/
	private String id;
	...
	private EmkProOrderBoxEntity emkProOrderBoxEntity;
	...
	public EmkProOrderBoxEntity getEmkProOrderBoxEntity() {
		return emkProOrderBoxEntity;
	}

	public void setEmkProOrderBoxEntity(EmkProOrderBoxEntity emkProOrderBoxEntity) {
		this.emkProOrderBoxEntity = emkProOrderBoxEntity;
	}
}
