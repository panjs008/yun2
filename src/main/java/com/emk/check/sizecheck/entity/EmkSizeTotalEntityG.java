...
public class EmkSizeTotalEntityG implements java.io.Serializable {
	/**主键*/
	private String id;
	...
	private EmkSampleDetailEntity emkSampleDetailEntity;
	...
	public EmkSampleDetailEntity getEmkSampleDetailEntity() {
		return emkSampleDetailEntity;
	}

	public void setEmkSampleDetailEntity(EmkSampleDetailEntity emkSampleDetailEntity) {
		this.emkSampleDetailEntity = emkSampleDetailEntity;
	}
}
