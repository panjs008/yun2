...
public class EmkSizeTotalEntityE implements java.io.Serializable {
	/**主键*/
	private String id;
	...
	private EmkEnquiryDetailEntity emkEnquiryDetailEntity;
	private String m0 = "";
	...
	public EmkEnquiryDetailEntity getEmkEnquiryDetailEntity() {
		return emkEnquiryDetailEntity;
	}

	public void setEmkEnquiryDetailEntity(EmkEnquiryDetailEntity emkEnquiryDetailEntity) {
		this.emkEnquiryDetailEntity = emkEnquiryDetailEntity;
	}
