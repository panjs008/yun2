...
public class EmkSizeTotalEntityH implements java.io.Serializable {
	/**主键*/
	private String id;
	...
	private EmkProduceDetailEntity emkProduceDetailEntity;
	...
	public EmkProduceDetailEntity getEmkProduceDetailEntity() {
		return emkProduceDetailEntity;
	}

	public void setEmkProduceDetailEntity(EmkProduceDetailEntity emkProduceDetailEntity) {
		this.emkProduceDetailEntity = emkProduceDetailEntity;
	}
}
