...
public class EmkSizeTotalEntityA implements java.io.Serializable {
	/**主键*/
	private String id;
	...
	private EmkSizeCheckDetailEntity emkSizeCheckDetailEntity;
	...
	public EmkSizeCheckDetailEntity getEmkSizeCheckDetailEntity() {
		return emkSizeCheckDetailEntity;
	}

	public void setEmkSizeCheckDetailEntity(EmkSizeCheckDetailEntity emkSizeCheckDetailEntity) {
		this.emkSizeCheckDetailEntity = emkSizeCheckDetailEntity;
	}
}
