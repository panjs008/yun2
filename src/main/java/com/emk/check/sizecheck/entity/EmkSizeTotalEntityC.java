...
public class EmkSizeTotalEntityC implements java.io.Serializable {
	/**主键*/
	private String id;
	...
	private EmkPackingListDetailEntity emkPackingListDetailEntity;
	...
	public EmkPackingListDetailEntity getEmkPackingListDetailEntity() {
		return emkPackingListDetailEntity;
	}

	public void setEmkPackingListDetailEntity(EmkPackingListDetailEntity emkPackingListDetailEntity) {
		this.emkPackingListDetailEntity = emkPackingListDetailEntity;
	}
}
