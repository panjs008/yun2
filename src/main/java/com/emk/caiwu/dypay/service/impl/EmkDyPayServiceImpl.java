package com.emk.caiwu.dypay.service.impl;
...
@Service("emkDyPayService")
@Transactional
public class EmkDyPayServiceImpl extends CommonServiceImpl implements EmkDyPayServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(EmkDyPayEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(EmkDyPayEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(EmkDyPayEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(EmkDyPayEntity t){
		...
		map.put("xqd_no", t.getXqdNo());
		map.put("cgd_no", t.getCgdNo());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,EmkDyPayEntity t){
 		...
 		sql  = sql.replace("#{xqd_no}",String.valueOf(t.getXqdNo()));
 		sql  = sql.replace("#{cgd_no}",String.valueOf(t.getCgdNo()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("emk_dy_pay",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
