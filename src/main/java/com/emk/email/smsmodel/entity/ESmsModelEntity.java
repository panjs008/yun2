package com.emk.email.smsmodel.entity;
 ...
 */
@Entity
@Table(name = "e_sms_model", schema = "")
@SuppressWarnings("serial")
public class ESmsModelEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
