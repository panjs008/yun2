package com.emk.email.smsrecord.service.impl;
...
@Service("eSmsRecordService")
@Transactional
public class ESmsRecordServiceImpl extends CommonServiceImpl implements ESmsRecordServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ESmsRecordEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(ESmsRecordEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(ESmsRecordEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(ESmsRecordEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ESmsRecordEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("e_sms_record",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
