$(document).ready(function(){
    BindSelectSupply("gysId","ymkCustomController.do?findSupplierList",1,$("#gysCode").val()+","+$("#gys").val()+","+$("#preBill").val());
...
function BindSelectSupply(ctrlName, url,type,categoryId) {
    ...
    $.getJSON(url, function (data) {
        ...
        $.each(data.obj, function (i, item) {
            control.append("<option value='" + item.companyCode + ","+item.companyNameZn +","+item.preBill+"'>" + item.companyNameZn + "</option>");
        });
