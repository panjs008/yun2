$(document).ready(function(){
    BindSelectCustom("cusId","ymkCustomController.do?findCustomListForSelect",1,$("#a01a05a02").val()+","+$("#cusName").val()+","+$("#bcqkMoney").val());

    $("#cusId").change(function(){
        var itemarr = $("#cusId").val().split(","); //字符分割
        $("#a01a05a02").val(itemarr[0]);
