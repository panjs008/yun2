w<%@ page language="java" import="java.util.*" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkClauseController.do?doAdd" tiptype="1">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value">
					<input id="clauseNum" name="clauseNum" datatype="*" type="text" style="width:90%" class="inputxt"  ignore="ignore" />
			...
			<tr>
				...
				<td class="value">
						<t:ckeditor name="clauseContent" type="height:330" value=""></t:ckeditor>
