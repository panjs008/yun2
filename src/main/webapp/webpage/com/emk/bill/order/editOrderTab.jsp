...
<head>
	...
	<script type="text/javascript">
        ...
        function save(){
            ...
            $("#orderFrm")[0].contentWindow.getRemarkContent();
...
<body>
<span style="text-align: left;float: left;font-size: 22px"><img src="images/order.jpg" style="float: left;width: 35px;height:35px;">&nbsp;<strong>订货订单&nbsp;${CUR_USER.currentDepart.departname}&nbsp;${CUR_USER.realName}&nbsp;${bz}&nbsp;<font color="red">${heji}</font>
	<c:if test="${order.state eq 0}"><font color="red">草拟</font></c:if>
...
<div class="easyui-tabs" style="height:475px;overflow:hidden" id="orderTabId">
	<div id="orderDiv" title="基本信息" style="height:500px;overflow:hidden" >
		<iframe scrolling="yes" id="orderFrm" frameborder="0" src="emkOrderController.do?goAdd&id=${param.id}" style="width:100%;height:100%;"></iframe>
	</div>
