...
<head>
	...
	<script type="text/javascript">
        ...
        function save(){
            ...
            var companyformStr = {};
            $.each(companyformArray,function (i,field) {
                companyformStr[field.name] = field.value;
            });
            ...
            $.ajax({
                url : "emkOrderController.do?doSave&companyformArray="+JSON.stringify(companyformStr),
                type : 'post',
                cache : false,
                data: formArray,
...
<body>
<span style="text-align: left;float: left;font-size: 22px"><img src="images/order.jpg" style="float: left;width: 35px;height:35px;">&nbsp;<strong>订货订单&nbsp;${CUR_USER.currentDepart.departname}&nbsp;${CUR_USER.realName}&nbsp;${bz}&nbsp;
