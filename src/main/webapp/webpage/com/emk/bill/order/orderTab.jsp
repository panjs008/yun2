...
<head>
	...
	<script type="text/javascript">
        ...
        function save(){
            ...
            $("#orderFrm")[0].contentWindow.getClauseContent();
            ...
            if($("#orderFrm").contents().find("#typeCode").val()==""){
                tip("贸易国别必填");
                return false;
            }
            ...
            for(var i=0;i<=indexFlag0;i++){
                ...
                result0["dopute"+i] = $("#orderFrm").contents().find("iframe").contents().find("#dopute"+i).val();
                result0["money"+i] = $("#orderFrm").contents().find("iframe").contents().find("#money"+i).val();
                result0["remark"+i] = $("#orderFrm").contents().find("iframe").contents().find("#remark"+i).val();
            }
            $.ajax({
                url : "emkOrderController.do?doSave&dataSize="+indexFlag0+"&gather="+JSON.stringify(result0),
                type : 'post',
                cache : false,
                data: formArray,
                success : function(data) {
                    ...
                    if (d.success) {
                        ...
                        $.ajax({
                            url:"emkOrderDetailController.do?saveRows&orderId="+d.obj+"&dataSize="+indexFlag+"&data="+JSON.stringify(result),
                            data:null,
                            type:'post',
                            success:function(data){
        ...
        function doSubmit(){
            ...
            $.ajax({
                url : "emkOrderController.do?doSubmit&dataSize="+indexFlag0+"&gather="+JSON.stringify(result0),
                type : 'post',
                cache : false,
                data: formArray,
                success : function(data) {
...
<body>
<span style="text-align: left;float: left;font-size: 22px"><img src="images/order.jpg" style="float: left;width: 35px;height:35px;">&nbsp;<strong>订货订单&nbsp;${CUR_USER.currentDepart.departname}&nbsp;${CUR_USER.realName}&nbsp;${bz}&nbsp;<font color="red">草拟</font></strong>&nbsp;&nbsp;</span>
...
<div id="orderTabId" class="easyui-tabs" style="height:475px;overflow:hidden">
	<div id="orderDiv" title="基本信息" style="height:500px;overflow:hidden" >
		<iframe scrolling="yes" id="orderFrm" frameborder="0" src="emkOrderController.do?goAdd" style="width:100%;height:100%;"></iframe>
	</div>
	<div id="proDiv" title="商品信息" style="padding:5px;height:440px;overflow:hidden" >
		<iframe scrolling="yes" id="proFrm"  frameborder="0"  src="emkOrderDetailController.do?list" style="width:100%;height:100%;"></iframe>
	</div>
...
<%--<t:tabs id="rkglTabs" iframe="false" tabPosition="top" fit="false">
	...
	<t:tab title="基本信息" id="orderFrm"  heigth="720"  width="100%" icon="" iframe="emkOrderController.do?goAdd"></t:tab>
	&lt;%&ndash;<t:tab title="商品信息" id="ciFrm2"  heigth="420" width="100%" icon="" iframe="emkOrderDetailController.do?orderDetailTab"></t:tab>&ndash;%&gt;
	<t:tab title="商品信息" id="proFrm"  heigth="420" width="100%" icon="" iframe="emkOrderDetailController.do?list"></t:tab>
