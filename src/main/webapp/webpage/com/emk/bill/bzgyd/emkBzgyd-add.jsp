...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkBzgydController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr id="dgrImageDiv">
			...
			<td class="value" rowspan="5">
				...
				<img id="uploadimg0" src="${emkBzgydPage.customSampleUrl eq null ? 'images/bjlogo.png':emkBzgydPage.customSampleUrl}" width="150" height="150">
		...
		<tr>
			...
			<td class="value">
				<input id="sumBoxTotal" name="sumBoxTotal"  datatype="n" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
