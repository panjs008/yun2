...
<html>
 <head>
  ...
  $(function(){
      ...
      $.ajax({
          url : "ymkCustomContactController.do?getContect&customId=${emkOrderCompanyTopPage.cusId}",
          type : 'post',
          cache : false,
          data: null,
	  ...
	  <table id="companyBaseInfoId" style="width: 100%;" cellpadding="0" cellspacing="0" class="formtable" border="0">
		  <tr>
			  <td align="right" class="value" style="color:red">
					...
					<td class="value">
						<input id="cusId" datatype="*" name="cusId" type="hidden" value="${emkOrderCompanyTopPage.cusId}" />

						<input class="easyui-combobox" name="customIdVal" value="${emkOrderCompanyTopPage.cusName}" style="width:170px;" data-options="
                    loader: myloader,
                    mode: 'remote',
                    valueField: 'id',
                    textField: 'name',
