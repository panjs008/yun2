...
<table id="mxtb" style="width:100%;" cellpadding="0" cellspacing="2" border="0">
    <tr bgcolor="#E6E6E6" style="height: 32px;">
        ...
        <td align="left" bgcolor="#EEEEEE" width="100">规格</td>
        <td align="left" bgcolor="#EEEEEE" width="90">采购数量</td>
        <td align="left" bgcolor="#EEEEEE" width="90">单价</td>
        <td align="left" bgcolor="#EEEEEE" width="90">入库数量</td>
        <td align="left" bgcolor="#EEEEEE" width="90">出库数量</td>
        <td align="left" bgcolor="#EEEEEE" width="90">剩余数量</td>
    ...
    <c:forEach items="${rkglMxList}" var="poVal" varStatus="status">
        <tr>
                ...
                <td align="left"><input id="brand${status.index}" nullmsg="请输入规格！" datatype="*" value="${poVal.brand}" errormsg="请输入规格" name="rkglMxList[${status.index}].brand" maxlength="100" type="text" value="0"
                                        style="width: 95%;"></td>
                <td align="left"><input id="signTotal0" nullmsg="请输入采购数量！" datatype="*" value="${poVal.total}" errormsg="请输入采购数量" name="rkglMxList[${status.index}].signTotal" maxlength="100" type="text" value="0"
                                        style="width: 95%;"></td>
                <td align="left"><input nullmsg="请输入单价！" id="signPrice0" datatype="*" value="${poVal.signPrice}" errormsg="请输入单价" name="rkglMxList[${status.index}].signPrice" maxlength="100" type="text" value="0"
                                        style="width: 95%;"></td>
                <td align="left"><input nullmsg="请输入入库数量！" id="inTotal0" errormsg="请输入入库数量" value="${poVal.inTotal}" name="rkglMxList[${status.index}].inTotal" maxlength="100" type="text" value=""
                                        style="width: 95%;"></td>
                <td align="left"><input nullmsg="请输入出库数量！" id="outTotal0" errormsg="请输入出库数量" value="${poVal.outTotal}" name="rkglMxList[${status.index}].outTotal" maxlength="100" type="text" value=""
                                        style="width: 95%;"></td>
                <td align="left"><input nullmsg="请输入剩余数量！" id="leavelTotal0" errormsg="请输入剩余数量" value="${poVal.leavelTotal}" name="rkglMxList[${status.index}].leavelTotal" maxlength="100" type="text" value=""
                                    style="width: 95%;"></td>
