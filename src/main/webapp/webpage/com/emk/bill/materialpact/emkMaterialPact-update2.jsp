...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkMaterialPactController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="partyA" name="partyA"  value="${emkMaterialPactPage.partyA}" type="text" style="width: 50%" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value">
				<input id="partyB" name="partyB"  value="${emkMaterialPactPage.partyB}" type="text" style="width: 50%" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
	...
	<t:tabs id="pactDetail" iframe="false"  tabPosition="top" fit="false">
		<t:tab href="emkMaterialPactController.do?orderMxList&type=${param.type}&flag=1&proOrderId=${emkMaterialPactPage.id}" icon="icon-search" title="${pactTypeName}" id="pact"></t:tab>
	</t:tabs>
