...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkProOrderController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="orderNo" name="orderNo" type="text" readonly value="${emkProOrderPage.orderNo }" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value">
				<input id="orderTime" name="orderTime" type="text" value="${emkProOrderPage.orderTime }" readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="cusNum" name="cusNum" type="hidden" value="${emkProOrderPage.cusNum }" class="inputxt"  ignore="ignore" />
				<input id="cusName" name="cusName" type="text" value="${emkProOrderPage.cusName }" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value">
				<input id="yunfei" name="yunfei" datatype="*" value="${emkProOrderPage.yunfei }" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="supplyTime" name="supplyTime" type="text" value="${emkProOrderPage.supplyTime }" readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="remark" name="remark" type="text" value="${emkProOrderPage.remark }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
