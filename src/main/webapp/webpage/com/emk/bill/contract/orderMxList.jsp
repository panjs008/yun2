...
<table id="mxtb" style="width:100%;" cellpadding="0" cellspacing="2" border="0">
    <tr bgcolor="#E6E6E6" style="height: 32px;">
        ...
        <td align="left" bgcolor="#EEEEEE" width="100">颜色</td>
        <td align="left" bgcolor="#EEEEEE" width="100">尺码</td>
        <td align="left" bgcolor="#EEEEEE" width="100">数量</td>
    ...
    <c:if test="${fn:length(emkProOrderDetailEntities)  > 0 }">
        <c:forEach items="${emkProOrderDetailEntities}" var="poVal" varStatus="status">
            <tr>
                ...
                <td align="left">
                    <select name="orderMxList[${status.index}].color" style="width: 70%;" nullmsg="请输入颜色！" errormsg="请输入颜色" datatype="*">
