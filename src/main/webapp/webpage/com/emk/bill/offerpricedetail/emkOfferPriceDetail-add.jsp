...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkOfferPriceDetailController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="offerPriceId" name="offerPriceId" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="signTotal" name="signTotal" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
							<span class="Validform_checktip"></span>
