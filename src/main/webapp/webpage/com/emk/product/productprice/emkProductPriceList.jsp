...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkProductPriceList" checkbox="true" pagination="true" pageSize="20" sortName="priceNo" sortOrder="asc" fitColumns="true" title="零售价表" actionUrl="emkProductPriceController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="价格名称"  field="priceName"  queryMode="single"  width="200"></t:dgCol>
