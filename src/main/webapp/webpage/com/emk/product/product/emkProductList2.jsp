...
<div class="easyui-layout" fit="true">
 <div region="west" style="width: 200px;" title="产品类别" split="true">
  ...
  <div region="center" style="padding:0px;border:0px">
      <t:datagrid name="emkProductList" checkbox="true"  pagination="true" fitColumns="false" title="" actionUrl="emkProductController.do?datagrid&type=2" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
   ...
   <t:dgCol title="所属部门"  field="sysOrgCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
     <%--  <t:dgCol title="款号"  field="hsCode"  queryMode="single"  width="120"></t:dgCol>
       <t:dgCol title="款号名称"  field="hsName"  queryMode="single"  width="150"></t:dgCol>--%>
          ...
          <t:dgCol title="包装辅料名称"  field="proZnName"  query="true" queryMode="single"  width="150"></t:dgCol>
          <t:dgCol title="包装辅料代码"  field="proNum" query="true"  queryMode="single"  width="120"></t:dgCol>
       ...
       <%--<t:dgCol title="英文名称"  field="proEnName"  query="true" queryMode="single"  width="120"></t:dgCol>--%>
          <t:dgCol title="包装辅料规格"  field="brand"  queryMode="single"  width="150"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="fa fa-plus" operationCode="add" url="emkProductController.do?goAdd&type=2&winTitle=录入包装辅料" funname="add" width="800" height="400"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="fa fa-edit" operationCode="edit" url="emkProductController.do?goUpdate&winTitle=编辑包装辅料" funname="update" width="800" height="400"></t:dgToolBar>
