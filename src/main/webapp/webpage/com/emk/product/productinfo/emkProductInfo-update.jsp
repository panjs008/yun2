...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkProductInfoController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="hsName" datatype="*"   name="hsName"  value="${emkProductPage.hsName }" type="text" style="width: 150px" class="inputxt"  />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" width="260">
				<input id="proNum" name="proNum" type="text" value="${emkProductPage.proNum }" validType="emk_product_info,pro_num,id" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="proTypeTree" d value="${proTypeName}">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" >
				<input id="proName" name="proName" type="text" value="${emkProductPage.proName }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" >
				<input id="price" name="price" type="text" datatype="d" value="${emkProductPage.price }" style="width: 150px" class="inputxt"  />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3"><textarea id="remark" style="width:95%;height:80px" class="inputxt" rows="5" name="remark">${emkProductPage.remark }</textarea>
				<span class="Validform_checktip"></span>
