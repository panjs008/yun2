...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkApprovalList" checkbox="false" pagination="true" fitColumns="false" pageSize="15" title="审批业务表" sortName="commitTime" sortOrder="desc" actionUrl="emkApprovalController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="当前节点名称"  field="processName" formatterjs="formatProcessName" queryMode="single"  width="150"></t:dgCol>
   ...
   <%--<t:dgCol title="审核时间"  field="bpmDate"  queryMode="single"  width="140"></t:dgCol>--%>
      <t:dgCol title="审核时间"  field="bpmDate"  query="true" queryMode="group"  width="140"></t:dgCol>

      <t:dgFunOpt funname="goToProcess(workNum,formId,commitId,processNode,status,type)" title="审批"  urlclass="ace_button"  urlStyle="background-color:#ec4758;" urlfont="fa-tasks"></t:dgFunOpt>
...
function formatProcessName(val,row){
 ...
 function goToProcess(workNum,id,createBy,processName,state,type){
     ...
     if(state == '2' || state == '4' || state == '5' || state == '7'  || state == '8' || state == '10' || state == '13' || state == '14' || state == '16' || state == '18' || state == '19'){
