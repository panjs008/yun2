...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkFobBusinessController.do?doUpdate" tiptype="1">
	<input id="fobId" name="fobId" type="hidden" value="${emkFobBusinessPage.id }"/>
	...
	<t:tabs id="detailDetail" iframe="false"  tabPosition="top" fit="false">
		<t:tab href="emkFobBusinessController.do?detailMxList&fobId=${emkFobBusinessPage.id}" icon="icon-search" title="明细" id="detail"></t:tab>
	</t:tabs>
</t:formvalid>
</body>
