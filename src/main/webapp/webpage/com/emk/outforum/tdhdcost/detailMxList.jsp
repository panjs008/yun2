...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <c:if test="${param.tdhdCostId eq null || param.tdhdCostId eq ''}">
            $('#addBtnSR').click();
        </c:if>
    });
...
<input id="orderMxListIDSR" type="hidden" name="orderMxListIDSR" value="${fn:length(emkTdhdCostDetailEntities)}"/>
<div class="table-c">
    <table id="mxtbSR" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            ...
            <td align="center"  width="150">生产合同号</td>
