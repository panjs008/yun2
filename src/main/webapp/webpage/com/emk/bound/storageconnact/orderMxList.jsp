...
<script type="text/javascript">
    ...
    $('#setBtn2').bind('click', function(){
        $.dialog({
            content: 'url:hmCategoryController.do?for&forColumn&parentCode=A01A18',
            zIndex: getzIndex(),
            title : '明细列配置',
            cache:false,
            lock : true,
...
<div style="padding: 3px; height: 29px; width:100%;margin-bottom:4px;margin-top: 2px; " class="datagrid-toolbar"><a id="addBtn" href="#" title="新增">新增</a><a id="copyBtn" href="#" title="复制行">复制行</a><a id="delBtn" href="#" title="删除">删除</a> <a id="setBtn2" href="#" title="明细列配置">列配置</a><%--<a id="refreshBtn" href="#" title="刷新">刷新</a>--%></div>
