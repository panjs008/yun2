...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkStorageConnactController.do?doAdd" tiptype="1">
	...
	<table id="headTb" style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="makeDate" name="makeDate" type="text" value="${kdDate }" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width: 150px" class="Wdate"  ignore="ignore"  value='${emkStorageConnactPage.makeDate}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="proZnNameB" name="proZnNameB" datatype="*" ondblclick="productLookForOne();" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${emkStorageConnactPage.proZnNameB}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="unitB" name="unitB" type="text" datatype="*" style="width: 150px" class="inputxt"  ignore="ignore"  value='${emkStorageConnactPage.unitB}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="total" name="total" type="text" style="width: 150px" class="inputxt"  datatype="*" value='${emkStorageConnactPage.total}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="price" name="price" type="text" datatype="d" style="width: 150px" class="inputxt"  value='${emkStorageConnactPage.price}'/>
				<span class="Validform_checktip"></span>
...
<script>
	$(document).ready(function(){
		...
		//$("#detailId").css("height",height-headTb);
	});
