...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkStorageConnactController.do?doAdd2" tiptype="1">
	...
	<input id="type" name="type" type="hidden" style="width: 150px" class="inputxt"  ignore="ignore"  value='1'/>
	...
	<table id="headTb" style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				<input id="proZnNameB" name="proZnNameB" ondblclick="productLookForOne();" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${emkStorageConnactPage.proZnNameB}'/>
				<span class="Validform_checktip"></span>
