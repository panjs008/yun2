...
<div class="table-c" >
    <table id="mxtb" border="0" style="width: 100%;display:block;" cellspacing="0" cellpadding="0">
        <thead style="display: inline-block;width: 100%;height: 20px;">
            <tr bgcolor="#F8F8F8" style="height: 32px;display:block;" >
        ...
        <tbody id="add_jeecgOrderProduct_table" style="display: inline-block;width: 100%; height: 200px; overflow: auto; ">
