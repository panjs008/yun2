        ...
        <c:forEach var="list" items="${categoryEntities}" varStatus="status">
            <td align="center" >
                <c:if test="${list.code eq 'a01a09a05'}">
                    <select id="${list.code}00" name="orderMxList[#index#].${list.code}" style="width:100px;">
...
<div style="padding: 3px; height: 25px; width:100%;margin-bottom:4px " class="datagrid-toolbar"><a id="addBtn" href="#" title="新增"></a><a id="copyBtn" href="#" title="复制行"></a><a id="delBtn" href="#" title="删除"></a> <a id="refreshBtn" href="#" title="刷新"></a><a id="setBtn" href="#" title="表头列配置"></a>  <a id="setBtn2" href="#" title="明细列配置"></a></div>
                    ...
                    <c:forEach var="list" items="${categoryEntities}" varStatus="catestatus">
                        <td align="center" >
                            ...
                            <c:if test="${list.code eq 'a01a09a05'}">
                                ...
                                <select id="a01a09a05${status.index}" name="orderMxList[${status.index}].${list.code}" value="${poVal[list.code]}" style="width:100px;">
                                    <option value=''>请选择</option>
                                </select>
                            </c:if>
                            <c:if test="${list.code ne 'a01a09a05'}">
