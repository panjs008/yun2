...
<div id="pcd_main" style="width:100%;height: 100%;">
	<div id="div_print" style="width:100%;height:14.85cm;">
		<br/>
		<span  style="font: '宋体';font-size: 26px;text-align: center;font-weight: bolder;">入库申请单</span><br/>
		<table class="pcd_normal_tb_foot" style="width:100%;">
			<tr>
					<td width="55%" align="left" height="20">填报日期：${emkMInStorage.kdDate}</td>
					<td width="45%" align="right">仓库名称：${emkMInStorage.storageName}&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
			<tr>
				<td width="55%" align="left" height="20">申请人：${emkMInStorage.appler}</td>
				<td width="45%" align="right">单号：${emkMInStorage.rkNo}&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<div  style="width:98%;">
