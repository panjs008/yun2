...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkMInStorageController.do?doUpdate" tiptype="1">
					...
					<c:if test="${headlist.required eq '0'}">
						<c:choose>
							...
							<c:when test="${headlist.column_type eq '5' && headlist.code eq 'a01a03a08'}">
								...
								<input id="${headlist.code}" name="${headlist.code}" readonly type="hidden" value="${emkMInStoragePage[headlist.code]}" style="width: 150px" class="inputxt"  ignore="ignore" />
								<input id="businesser" name="businesser"  type="hidden" value="${emkMInStoragePage.businesser }" />
					...
					<c:if test="${headlist.required ne '0'}">
						<c:choose>
							...
							<c:when test="${headlist.column_type eq '5' && headlist.code eq 'a01a03a08'}">
								...
								<input id="${headlist.code}" name="${headlist.code}" readonly value="${emkMInStoragePage[headlist.code]}" type="hidden"  style="width: 150px" class="inputxt"  ignore="ignore" />
								<input id="businesser" name="businesser"  type="hidden" value="${emkMInStoragePage.businesser }" />
					...
					<c:if test="${headlist.required eq '0'}">
						<c:choose>
							...
							<c:when test="${headlist.column_type eq '5' && headlist.code eq 'a01a03a08'}">
								...
								<input id="${headlist.code}" name="${headlist.code}" value="${emkMInStoragePage[headlist.code]}" readonly type="hidden"  style="width: 150px" class="inputxt"  ignore="ignore" />
								<input id="businesser" name="businesser"  type="hidden" value="${emkMInStoragePage.businesser }" />
	...
	<table id="footTb" style="width: 100%;position:fixed; left:0; bottom:0;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" >
				<input id="qcqkMoney" name="qcqkMoney"  datatype="d" readonly value="${emkMInStoragePage.qcqkMoney}"  style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value" colspan="3">
				<input id="ljqkMoney" name="ljqkMoney"  datatype="d" readonly value="${emkMInStoragePage.ljqkMoney}"  style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
