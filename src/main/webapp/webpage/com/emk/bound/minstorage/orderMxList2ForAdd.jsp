   ...
   function refreshT(){
    ...
    $(document).ready(function(){
        ...
        <c:if test="${param.inStorageId eq null || param.inStorageId eq ''}">
            <%--var totalY = ${fn:length(emkProOrderDetailEntityList)}+9;--%>
            for(var i = 1 ; i <=9 ; i++){
                $('#addBtn').click();
            }
        </c:if>
...
<div style="padding: 3px; height: 29px; width:100%;margin-bottom:4px;margin-top: 2px; " class="datagrid-toolbar"><a id="addBtn" href="#" title="新增">新增</a><a id="copyBtn" href="#" title="复制行">复制行</a><a id="delBtn" href="#" title="删除">删除</a><c:if test="${param.inStorageId eq null || param.inStorageId eq ''}"><a id="saleBtn" href="#" title="销售订单">销售订单</a> </c:if><a id="setBtn" href="#" title="表头列配置">表头列</a>  <a id="setBtn2" href="#" title="明细列配置">列配置</a></div>
