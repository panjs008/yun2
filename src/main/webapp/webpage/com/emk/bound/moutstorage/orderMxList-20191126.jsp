...
<div style="display:none">
    ...
    <t:choose  hiddenName="id"  hiddenid="id" url="emkProductController.do?proSelect&selectType=0" name="emkProductList" width="820px" height="500px"
               icon="icon-search" title="选择产品" textname="id,proType,proTypeName,proZnName,standards,brand,unit,scqy,lincese,zcNum,scDate,limitDate,betch,cytj" isclear="true" isInit="true"></t:choose>
</div>
...
<div class="table-c" >
    <table id="mxtb" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            ...
            <td align="center"  width="145">产品编号</td>
            <td align="center"  width="160">规格</td>
            <td align="center"  width="120">型号</td>
            <td align="center"  width="45">单位</td>
            <td align="center"  width="150">生产企业</td>
            <td align="center"  width="120">许可证号</td>
            <td align="center"  width="120">注册证号</td>
            ...
            <c:forEach items="${rkglMxList}" var="poVal" varStatus="status">
                <tr>
                    ...
                    <td align="center"><input  nullmsg="请输入产品名称！" id="proZnName${status.index}" ondblclick="productLook(${status.index});" onkeyup="getProduct(${status.index})"  errormsg="请输入产品名称" value="${poVal.proZnName}" name="orderMxList[${status.index}].proZnName" maxlength="100" type="text" value=""
                                               style="width: 92%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入产品编号！" id="proNum${status.index}"   errormsg="请输入产品编号" value="${poVal.proNum}" name="orderMxList[${status.index}].proNum" maxlength="100" type="text" value=""
                                               style="width: 92%;" ignore="ignore"></td>
