...
<table style="width:100%;display: none;border: 1px;" cellpadding="0" cellspacing="2" border="0">
    ...
    <tr>
        ...
        <td align="center">
           ...
           <%-- <input id="gyzl00" nullmsg="请输入工艺大类！"  errormsg="请输入工艺大类" name="orderMxList[#index#].gyzl00" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore">--%></td>
...
<div class="table-c" style="overflow: auto; width: 100%;">
    <table id="mxtbSR" width="4900px"  border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            <td align="center"  width="40" rowspan="3"><input type="checkbox" onclick="selectAll(this.checked)" /></td>
            <td align="center"  width="120" colspan="21"></td>
        ...
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            ...
            <td align="center"  width="70" rowspan="2">客户代码</td>
            <td align="center"  width="130" rowspan="2">生产合同号</td>
            <td align="center"  width="90" rowspan="2">供应商代码</td>
