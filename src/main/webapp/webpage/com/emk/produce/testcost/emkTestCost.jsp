...
<t:tabs id="repairTabId" iframe="false" heigth="600px" tabPosition="top" fit="true" >
    <t:tab title="任务处理" id="orderFrm"  heigth="600px"  width="100%" href="emkTestController.do?goWork&id=${param.id}" icon="fa fa-crosshairs"></t:tab>
    <t:tab title="基本信息" id="orderFrm"  heigth="600px"  width="100%" iframe="emkTestController.do?goUpdate2&id=${param.id}" icon="fa fa-calendar"></t:tab>
