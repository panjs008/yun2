...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkProduceScheduleController.do?doUpdate" tiptype="1">
	<input id="produceId" name="produceId" type="hidden" value="${emkProduceSchedulePage.id }"/>
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="createName" name="createName"  value="${CUR_USER.createName}"   type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				<input id="businesseDeptName" name="businesseDeptName" value="${emkProduceSchedulePage.businesseDeptName }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
	...
	<t:tabs id="detailDetail" iframe="false"  tabPosition="top" fit="false">
		<t:tab href="emkProduceScheduleController.do?detailMxList&pId=${emkProduceSchedulePage.id}" icon="icon-search" title="明细" id="detail"></t:tab>
	</t:tabs>
</t:formvalid>
</body>
