...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <c:if test="${param.outForumId eq null || param.outForumId eq ''}">
            $('#addBtnSR').click();
        </c:if>
    });
    ...
    <tr>
       ...
       <%-- <td align="center"><input id="signTotal00" nullmsg="请输入数量！"  datatype="n" errormsg="请输入整数" name="orderMxList[#index#].signTotal00" maxlength="100" type="text" value=""
        ...
        <td align="center"><input id="price00" nullmsg="请输入单价！"  datatype="d" errormsg="请输入数值" name="orderMxList[#index#].price00" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="sumPrice00" nullmsg="请输入金额！"  datatype="d" errormsg="请输入数值" name="orderMxList[#index#].sumPrice00" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="sumMoney00" nullmsg="请输入总金额！"  datatype="d" errormsg="请输入数值" name="orderMxList[#index#].sumMoney00" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="sumTotal00" nullmsg="请输入箱数！"  datatype="n" errormsg="请输入整数" name="orderMxList[#index#].sumTotal00" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
    </tr>
    </tbody>
...
<div class="table-c">
    <table id="mxtbSR" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            ...
            <td align="center"  width="90" rowspan="2">款号</td>
            ...
            <td align="center"  width="60" rowspan="2">总金额</td>
            <td align="center"  width="60" rowspan="2">箱数</td>
                ...
                <tr>
                   ...
                   <%-- <td align="center">
                    ...
                    <td align="center"><input  nullmsg="请输入单价！"  errormsg="请输入数值" datatype="d" value="${poVal.price}" name="orderMxList[${status.index}].price00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入金额！"  errormsg="请输入数值" datatype="d" value="${zsl*poVal.price}" name="orderMxList[${status.index}].sumPrice00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入总金额！"  errormsg="请输入数值" datatype="d" value="${poVal.sumMoney}" name="orderMxList[${status.index}].sumMoney00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入箱数！"  errormsg="请输入整数" datatype="n" value="${poVal.sumTotal}" name="orderMxList[${status.index}].sumTotal00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                </tr>
