...
<table id="mxtb" style="width:100%;" cellpadding="0" cellspacing="2" border="0">
    <tr bgcolor="#E6E6E6" style="height: 32px;">
        ...
        <td align="left" bgcolor="#EEEEEE" width="150">颜色</td>
        <td align="left" bgcolor="#EEEEEE" width="150">尺码</td>
        <td align="left" bgcolor="#EEEEEE" width="150">数量</td>
        <td align="left" bgcolor="#EEEEEE" width="150">单价</td>
    </tr>
        ...
        <c:forEach items="${emkProOrderDetailEntities}" var="poVal" varStatus="status">
            <tr>
                ...
                <td align="left"><input id="signTotal0" nullmsg="请输入数量！" datatype="*" value="${poVal.total}" errormsg="请输入整数" name="orderMxList[${status.index}].signTotal" maxlength="100" type="text" value="0"
                                        style="width: 80%;"></td>
                <td align="left"><input id="signPrice00" nullmsg="请输入单价！"  value="${poVal.price}"  errormsg="请输入单价" name="orderMxList[${status.index}].signPrice" maxlength="100" type="text" value=""
                                        style="width: 80%;"></td>
