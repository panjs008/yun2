	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value"  colspan="3">
				<input id="cusName" name="cusName" readonly type="text" value="${emkExamTimePage.cusName }" style="width: 150px" class="inputxt"  datatype="*"/>
		...
		<tr id="dgrImageDiv">
			...
			<td class="value" rowspan="5">
				...
				<img id="uploadimg0" src="${emkExamTimePage.customSampleUrl eq '' ? 'images/bjlogo.png':emkExamTimePage.customSampleUrl}" width="150" height="150">
		...
		<tr>
			...
			<td class="value" >
				...
				<input id="businesser" name="businesser" value="${emkExamTimePage.businesser }" readonly type="hidden" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value" >
				...
				<input id="tracer" name="tracer" readonly type="hidden" value="${emkExamTimePage.tracer }" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" >
				...
				<input id="developer" name="developer" readonly type="hidden" value="${emkExamTimePage.developer }" style="width: 150px" class="inputxt"  ignore="ignore" />
