...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkTestController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" >
				<input id="cssqdh" name="cssqdh" value="${emkTestPage.cssqdh }" readonly type="text" style="width: 150px" class="inputxt" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" >
				<input id="produceNum" name="produceNum" value="${emkTestPage.produceNum }" validType="emk_test,produceNum,id" type="text" style="width: 150px" class="inputxt"  datatype="*" />
				<span class="Validform_checktip"></span>
