...
<html>
 <head>
  ...
  $(document).ready(function(){
	  $("#detailId").load("emkQualityCheckController.do?orderMxList");
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<tr>
					...
					<td class="value">
						<input id="wuji" name="wuji" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="youji" name="youji" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="qimao" name="qimao" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="duans" name="duans" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="chous" name="chous" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="fans" name="fans" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="pod" name="pod" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="hengw" name="hengw" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="ranhua" name="ranhua" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="secha" name="secha" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="psbl" name="psbl" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="baokou" name="baokou" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="xt" name="xt" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="dx" name="dx" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="lk" name="lk" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="zybdc" name="zybdc" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="tjbl" name="tjbl" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="rongzhou" name="rongzhou" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="zhikou" name="zhikou" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="chicun" name="chicun" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="mczs" name="mczs" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="tgbl" name="tgbl" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="gwfxcw" name="gwfxcw" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="bxbl" name="bxbl" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="xzbl" name="xzbl" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="lwl" name="lwl" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value" colspan="3">
						<input id="zhenkong" name="zhenkong" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="gcdp" name="gcdp" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="cdtxm" name="cdtxm" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="gpwzcw" name="gpwzcw" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="yjyc" name="yjyc" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="yjfxcw" name="yjfxcw" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="gdgc" name="gdgc" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="clms" name="clms" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="jdncmcw" name="jdncmcw" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="jdnpbcw" name="jdnpbcw" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="zxzmhs" name="zxzmhs" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="bzwgbl" name="bzwgbl" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="txmbnsm" name="txmbnsm" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="dpbw" name="dpbw" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="tzbw" name="tzbw" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
