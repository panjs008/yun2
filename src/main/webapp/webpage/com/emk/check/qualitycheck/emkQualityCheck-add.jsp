...
<head>
	...
	<script>
		function save(){
			...
			$.ajax({
				url : "emkQualityCheckController.do?doAdd",
				type : 'post',
				cache : false,
				data: baseformArray,
				success : function(data) {
					...
					if (d.success) {
						...
						console.log(d.obj);
						$.ajax({
							url: "emkSizeCheckController.do?doAdd&qualityCheckId="+ d.obj,
							type: 'post',
							cache: false,
							data: sizeCheck,
							success: function (data) {
...
<iframe id="tabfrm" src="emkQualityCheckController.do?goTab&hVal2=${param.hVal2}" width="100%"  height="${param.hVal}"
