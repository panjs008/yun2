		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value" colspan="5">
							<textarea  id="askWorkAdvice" style="width:95%;height:50px" class="inputxt" rows="3" name="askWorkAdvice">${emkWorkOrderPage.askWorkAdvice}</textarea>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">询盘处理意见</label>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="value" colspan="5">
							<textarea  id="sampleAdvice" style="width:95%;height:50px" class="inputxt" rows="3" name="sampleAdvice">${emkWorkOrderPage.sampleAdvice}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" colspan="5">
							<textarea  id="sampleCheckAdvice" style="width:95%;height:50px" class="inputxt" rows="3" name="sampleCheckAdvice">${emkWorkOrderPage.sampleCheckAdvice}</textarea>
							<span class="Validform_checktip"></span>
