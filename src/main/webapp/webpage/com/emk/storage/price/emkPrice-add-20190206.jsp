...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkPriceController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" >
				<input id="xpNo" name="xpNo" datatype="*"  type="text" validType="emk_price,xp_no,id" style="width: 140px" class="inputxt"  />
		...
		<tr>
			...
			<td class="value" >
				<input id="cusNum" name="cusNum" readonly type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value" colspan="5">
				<input id="cusName" name="cusName" readonly type="text" datatype="*" style="width: 140px" class="inputxt"  />
		...
		<tr>
			...
			<td class="value" >
				<input id="businesseDeptName" name="businesseDeptName" readonly type="text" style="width: 140px" class="inputxt"   />
			...
			<td class="value" >
				<select class="form-control select2" datatype="*"  id="businesserId"  >
			...
			<td class="value">
				...
				<input id="proTypeName" name="proTypeName" datatype="*"  type="hidden" style="width: 140px" class="inputxt"  ignore="ignore" />
				<input id="proType" name="proType" type="hidden" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="sampleNo" name="sampleNo" type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="kdDate" name="kdDate" readonly value="${kdDate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 140px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="limitDate" name="limitDate" readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 140px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="guoJia" name="guoJia"  type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="bz" name="bz" readonly type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="weight" name="weight" type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="chengf" name="chengf" type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="targetPrice" name="targetPrice" type="text" datatype="d" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="evlateTotal" name="evlateTotal"  datatype="n" type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="7">
				<input id="sizeFawei" name="sizeFawei" type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="xjkz" name="xjkz" datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="djsxTime" name="djsxTime"  type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="qdshl" name="qdshl" datatype="d"  type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value" colspan="5">
				<input id="hdshl" name="hdshl"  datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="sumYl" name="sumYl" datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="sumRan" name="sumRan" datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="unableMoney" name="unableMoney" datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="huilv" name="huilv" datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="huilvDate" name="huilvDate" readonly value="${kdDate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" class="Wdate"  style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="argeePrice" name="argeePrice" datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="maoRate" name="maoRate"  datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="gysArgeePrice" name="gysArgeePrice" datatype="d" type="text" style="width: 140px"  ignore="ignore" />
				<span class="Validform_checktip"></span>
