...
<script type="text/javascript">
    var flag = ${fn:length(emkFormaterailDetailEntityList)};
    var currentFlag = ${fn:length(emkFormaterailDetailEntityList)};
    ...
    $(document).ready(function(){
        ...
        <c:if test="${param.formaterialId eq null || param.formaterialId eq ''}">
            $('#addBtn').click();
        </c:if>
    });
...
<table style="width:100%;display: none;border: 1px;" cellpadding="0" cellspacing="2" border="0">
    ...
    <tr>
        ...
        <td align="center"><input id="totalP" nullmsg="请输入数量！"  datatype="n"  errormsg="请输入整数" name="orderMxList[#index#].totalP" maxlength="100" type="text"
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="total00" nullmsg="请输入米数！"  datatype="n"  errormsg="请输入整数" name="orderMxList[#index#].total" maxlength="100" type="text"
                                  style="width: 86%;" ignore="ignore"></td>
...
<input id="listSize" type="hidden" value="${fn:length(emkFormaterailDetailEntityList)}"/>
<input id="orderMxListID" type="hidden" name="dataRowsVal" value="${fn:length(emkFormaterailDetailEntityList)}"/>
<div class="table-c" style="margin-top:5px;">
    <table id="mxtb" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td align="center" ><input  value="${emkSizePage.sizeK eq null ? '':emkSizePage.sizeK}" name="sizeK" maxlength="100" type="text"  style="width: 80%;" ignore="ignore"></td>
            <td align="center" ><input  value="${emkSizePage.sizeL eq null ? '':emkSizePage.sizeL}" name="sizeL" maxlength="100" type="text"  style="width: 80%;" ignore="ignore"></td>
            <td align="center" ><input  value="${emkSizePage.sizeM eq null ? '':emkSizePage.sizeM}" name="sizeM" maxlength="100" type="text"  style="width: 80%;" ignore="ignore"></td>
            <td align="center" ><input  value="${emkSizePage.sizeN eq null ? '':emkSizePage.sizeN}" name="sizeN" maxlength="100" type="text"  style="width: 80%;" ignore="ignore"></td>
            <td align="center" ><input  value="${emkSizePage.sizeO eq null ? '':emkSizePage.sizeO}" name="sizeO" maxlength="100" type="text"  style="width: 80%;" ignore="ignore"></td>
            <td align="center" ><input  value="${emkSizePage.sizeP eq null ? '':emkSizePage.sizeP}" name="sizeP" maxlength="100" type="text"  style="width: 80%;" ignore="ignore"></td>

        </tr>
        <tbody id="add_jeecgOrderProduct_table">
        <c:if test="${fn:length(emkFormaterailDetailEntityList)  > 0 }">
            <c:set var="zj" value="0"/>
            <c:forEach items="${emkFormaterailDetailEntityList}" var="poVal" varStatus="status">
                <tr>
                    ...
                    <td align="center">
                        ...
                        <script>
                            BindColorSelect("color${status.index}", colorJson,"1","${poVal.pm}-${poVal.colorNum}");
                        </script>
