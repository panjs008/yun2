...
<head>
	...
	<script type="text/javascript">
		...
		function importExcel(){
			...
			$.ajax({
				url:'emkCancelOrderController.do?importExcel',
				type : 'post',
				cache : false,
...
<t:formvalid formid="formobj"  dialog="true" usePlugin="password" layout="table" action="" tiptype="1" >
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="cancelDate" name="cancelDate" readonly value="${kdDate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
