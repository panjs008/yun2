...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkCancelOrderController.do?doUpdate" tiptype="1">
	<input id="emkMInStorageId" name="emkMInStorageId" type="hidden" value="${emkCancelOrderPage.id }"/>
					...
					<c:if test="${headlist.required eq '0'}">
						<c:choose>
							...
							<c:when test="${headlist.column_type eq '5' && headlist.code eq 'a01a16a11'}">
								...
								<input id="${headlist.code}" name="${headlist.code}" type="hidden" value="${emkCancelOrderPage[headlist.code]}" style="width: 150px" class="inputxt"  ignore="ignore" />
								<input id="storageName" name="storageName" type="hidden" value="${emkCancelOrderPage.storageName }"/>
							...
							<c:when test="${headlist.column_type eq '5' && headlist.code eq 'a01a16a08'}">
								...
								<input id="${headlist.code}" name="${headlist.code}" readonly type="hidden" value="${emkCancelOrderPage[headlist.code]}" style="width: 150px" class="inputxt"  ignore="ignore" />
								<input id="businesser" name="businesser"  type="hidden" value="${emkCancelOrderPage.businesser }" />
					...
					<c:if test="${headlist.required ne '0'}">
						<c:choose>
							...
							<c:when test="${headlist.column_type eq '5' && headlist.code eq 'a01a16a08'}">
								...
								<input id="${headlist.code}" name="${headlist.code}" readonly value="${emkCancelOrderPage[headlist.code]}" type="hidden"  style="width: 150px" class="inputxt"  ignore="ignore" />
								<input id="businesser" name="businesser"  type="hidden" value="${emkCancelOrderPage.businesser }" />
					...
					<c:if test="${headlist.required eq '0'}">
						<c:choose>
							...
							<c:when test="${headlist.column_type eq '5' && headlist.code eq 'a01a16a11'}">
								...
								<input id="${headlist.code}" name="${headlist.code}" value="${emkCancelOrderPage[headlist.code]}" type="hidden" style="width: 150px" class="inputxt"  ignore="ignore" />
								<input id="storageName" name="storageName" type="hidden" value="${emkCancelOrderPage.storageName }"/>
							...
							<c:when test="${headlist.column_type eq '5' && headlist.code eq 'a01a16a08'}">
								...
								<input id="${headlist.code}" name="${headlist.code}" value="${emkCancelOrderPage[headlist.code]}" readonly type="hidden"  style="width: 150px" class="inputxt"  ignore="ignore" />
								<input id="businesser" name="businesser"  type="hidden" value="${emkCancelOrderPage.businesser }" />
	...
	<table id="footTb" style="width: 100%;position:fixed; left:0; bottom:0;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" >
				<input id="qcqkMoney" name="qcqkMoney"  datatype="d" readonly value="${emkCancelOrderPage.qcqkMoney}"  style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value" colspan="3">
				<input id="ljqkMoney" name="ljqkMoney"  datatype="d" readonly value="${emkCancelOrderPage.ljqkMoney}"  style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
...
<script src="${webRoot}/context/gysForColCancelUpt.js"></script>
