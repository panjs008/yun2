...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkEnquiryDetailController.do?doAdd" tiptype="1">
					<input id="id" name="id" type="hidden" value="${emkEnquiryDetailPage.id }"/>
	  <input id="enquiryId" name="enquiryId" type="hidden" value="${param.enquiryId }"/>
	  <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						<t:dictSelect id="size" field="size" typeGroupCode="size" datatype="*" defaultVal="default" hasLabel="false" title="尺码"></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="total" name="total" datatype="n" type="text" style="width: 150px" class="inputxt"  />
							<span class="Validform_checktip"></span>
				...
				<%--<tr>
					...
					<td class="value">
					     	 <input id="sizeTotal" name="sizeTotal" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="colorTotal" name="colorTotal" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="price" name="price" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"   />
							<span class="Validform_checktip"></span>
