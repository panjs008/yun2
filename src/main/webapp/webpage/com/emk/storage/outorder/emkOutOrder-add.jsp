...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkOutOrderController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="outDate" name="outDate" readonly value="${kdDate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="*"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				...
				<input id="gys" name="gys" type="text"  value="${factoryArchivesEntity.companyNameZn }"  style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="betch" name="betch" type="text" validType="emk_out_order,betch,id,outDate"  style="width: 150px" class="inputxt" datatype="*"   value='${emkOutOrderPage.betch}'/>
				<span class="Validform_checktip"></span>
