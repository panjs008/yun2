...
<div id="pcd_main" style="width:100%;height: 100%;">
	<div id="div_print" style="width:100%;height:14.85cm;">
		<br/>
		<span  style="font: '宋体';font-size: 26px;text-align: center;font-weight: bolder;">${enquiryEntity.outDate}出货</span><br/>
		<table class="pcd_normal_tb_foot" style="width:100%;">
			<tr>
				<td width="50%" align="left" height="20">供应商名称：${enquiryEntity.gys }</td>
				<td width="50%" align="right">订单号：${enquiryEntity.orderNo}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
			<tr>
				<td width="50%" align="left" height="20">出货批次：${enquiryEntity.betch }</td>
