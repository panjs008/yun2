			...
			$.ajax({
				...
				success : function(data) {
					...
					if (d.success) {
						...
						if(${emkFactoryArchivesPage.chengShi ne '' && emkFactoryArchivesPage.chengShi ne null && emkFactoryArchivesPage.shengFen ne '' and emkFactoryArchivesPage.shengFen ne null}){
							$.ajax({
								...
								success : function(data) {
									...
									if (d.success) {
										...
										if(${emkFactoryArchivesPage.pianQu ne '' && emkFactoryArchivesPage.pianQu ne null && emkFactoryArchivesPage.chengShi ne '' and emkFactoryArchivesPage.chengShi ne null}) {
											$.ajax({
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkFactoryArchivesController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				<input id="zjm" name="zjm" type="text"  value="${emkFactoryArchivesPage.zjm }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
