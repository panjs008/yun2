...
<table style="width:100%;display: none;border: 1px;" cellpadding="0" cellspacing="2" border="0">
    ...
    <tr>
        ...
        <td align="center">
            <%--<select id="color00" name="orderMxList[#index#].color" style="width: 86%;" nullmsg="请输入颜色！" errormsg="请输入颜色" datatype="*">
        ...
        <td align="center">
            <input id="colorNum00" nullmsg="请输入色号！" datatype="n"  errormsg="请输入色号" name="orderMxList[#index#].colorNum" maxlength="100" type="text"
        ...
        <td align="center"><input id="signTotal00" nullmsg="请输入数量！"  errormsg="请输入整数" name="orderMxList[#index#].signTotal00" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>--%>
        ...
        <td align="center"><input id="totalK" nullmsg="请输入数量！"  datatype="n"  errormsg="请输入整数" name="orderMxList[#index#].totalK" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="sjTotal00" nullmsg="请输入数量！"  errormsg="请输入整数" name="orderMxList[#index#].sjTotal00" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
...
<div class="table-c">
    <table id="mxtbSR" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            ...
            <td align="center"  width="90" rowspan="2">色号</td>
            <td align="center"  width="400" colspan="11" >尺码</td>
            <td align="center"  width="120" rowspan="2">实际打样数量</td>
        </tr>
        <tr>
        ...
        <c:if test="${fn:length(emkProOrderDetailEntities)  > 0 }">
            ...
            <c:forEach items="${emkProOrderDetailEntities}" var="poVal" varStatus="status">
                ...
                <tr>
                    ...
                    <td align="center">
                      <%--  <select id="color${status.index}" name="orderMxList[${status.index}].color" onchange="setColorNumItem(${status.index})" style="width: 86%;" nullmsg="请输入颜色！" errormsg="请输入颜色" datatype="*">
                            <c:forEach items="${colorList}" var="category">
                                <option value="${category.typecode}" ${category.code eq poVal.color ? 'selected':''}>${category.typename}</option>
                            </c:forEach>
                        </select>--%>
                    ...
                    <td align="center">
                        ...
                        <input id="colorNum${status.index}" nullmsg="请输入色号！" value="${poVal.colorValue}" datatype="n"  errormsg="请输入色号" name="orderMxList[${status.index}].colorNum" maxlength="100" type="text"
                               style="width: 86%;" ignore="ignore"/>
                    </td>
        ...
        <tr>
            ...
            <td align="center" colspan="12">${zjs}</td>
        </tr>
    </table>
</div>
