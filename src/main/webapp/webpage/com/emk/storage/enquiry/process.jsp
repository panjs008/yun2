...
<script>
    $(document).ready(function() {
        ...
        <%--$("#hisProcessDiv").load("flowController.do?processHis&sqlType=enquiry&id=${param.id}");--%>

    });
</script>
<div id="orderDiv" title="流程图" style="width:100%;height:43%;;overflow:hidden" >
    <iframe scrolling="no" id="processFrm" frameborder="0" style=""  src="flowController.do?showProcess&id=${param.id}&tableName=emk_enquiry" width="100%" height="100%"></iframe>
</div>
...
<%--<div id="hisProcessDiv" style="overflow-x:hidden;overflow-y:hidden"></div>--%>

<div id="hisProcessDiv" title="" style="width:100%;height:57%;overflow:hidden;overflow-x: hidden;overflow-y: hidden" >
    <iframe scrolling="no" id="hisProcessFrm" frameborder="0" style="overflow-x: hidden;overflow-y: hidden"  src="flowController.do?processHis&sqlType=enquiry&id=${param.id}" width="100%" height="100%"></iframe>
</div>
