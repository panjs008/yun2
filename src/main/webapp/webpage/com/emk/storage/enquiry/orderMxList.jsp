...
<div class="table-c" style="margin-top:5px;">
    <table id="mxtb" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            ...
            <td align="center"  width="600" colspan="22" >尺码</td>
        ...
        <tr>
            ...
            <td align="center" ><input  value="${emkSizePage.sizeQ}" name="sizeQ" maxlength="100" type="text"  style="width: 80%;" ignore="ignore"></td>
