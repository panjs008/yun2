...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkFinanceYfCheckController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				...
				<input id="gysCode" name="gysCode" type="hidden" style="width: 120px" class="inputxt"  ignore="ignore" />
				<input id="gys" name="gys" type="hidden" style="width: 120px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
