...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkFinanceCheckController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" >
				<input id="cusNum" name="cusNum" readonly type="hidden" value="${emkFinanceCheckPage.cusNum }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<input id="cusName" name="cusName" readonly type="text" value="${emkFinanceCheckPage.cusName }" style="width: 150px" class="inputxt"  datatype="*"/>
		...
		<tr>
			...
			<td class="value">
				<input id="money" name="money" type="text" datatype="d" value="${emkFinanceCheckPage.money }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value"  >
				...
				<input id="businesser" name="businesser" readonly value="${emkFinanceCheckPage.businesser }" type="hidden" style="width: 150px" class="inputxt"  ignore="ignore" />
