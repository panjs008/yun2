...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkFinanceCheckController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" >
				...
				<input id="gysCode" name="gysCode" type="hidden" value="${emkFinanceCheckPage.gysCode }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<input id="gys" name="gys" type="hidden" value="${emkFinanceCheckPage.gys }" style="width: 150px" class="inputxt"  ignore="ignore" />
