...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkEquipController.do?doAdd" tiptype="1">
	  ...
	  <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		  ...
		  <tr>
			  ...
			  <td class="value">
				  <input id="gzbh" name="gzbh" type="text" datatype="*" validType="emk_equip,gzbh,id" style="width: 150px" class="inputxt" >
				  <span class="Validform_checktip"></span>
			  ...
			  <td class="value">
				  <input id="zcmc" name="zcmc" type="text" datatype="*" style="width: 150px" class="inputxt" >
				  <span class="Validform_checktip"></span>
		  ...
		  <tr>
			  ...
			  <td class="value">
				  <input id="xlh" datatype="*" name="xlh" type="text" style="width: 150px" class="inputxt" >
				  <span class="Validform_checktip"></span>
		  ...
		  <tr>
			  ...
			  <td class="value">
				  <input id="wz" name="wz" type="text" style="width: 150px" class="inputxt" >
				  <span class="Validform_checktip"></span>
			  ...
			  <td class="value">
				  <input id="yt" name="yt" type="text"  style="width: 150px" class="inputxt" >
				  <span class="Validform_checktip"></span>
		  ...
		  <tr>
			  ...
			  <td class="value">
				  <input id="zt" name="zt" type="text" style="width: 150px" class="inputxt" >
				  <span class="Validform_checktip"></span>
			  ...
			  <td class="value">
				  <input id="gs" name="gs" type="text" style="width: 150px" class="inputxt" >
				  <span class="Validform_checktip"></span>
		  ...
		  <tr>
			  ...
			  <td class="value">
				  <input id="sjrq" name="sjrq" type="text" readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" type="text" style="width: 150px" class="Wdate" >
				  <span class="Validform_checktip"></span>
			  ...
			  <td class="value">
				  <input id="tgr" name="tgr"  type="text" style="width: 150px" class="inputxt" >
				  <span class="Validform_checktip"></span>
