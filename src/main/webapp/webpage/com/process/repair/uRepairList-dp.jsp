...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="uRepairList" checkbox="true" pagination="true" fitColumns="true" title="" actionUrl="uRepairController.do?dpdatagrid&status=2" sortName="applyDate" sortOrder="desc" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
            ...
            <t:dgFunOpt funname="" title="改派" urlclass="ace_button" urlStyle="background-color:#18a689;" urlfont="fa-sign-out"></t:dgFunOpt>
