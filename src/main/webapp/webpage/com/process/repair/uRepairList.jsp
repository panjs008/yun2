...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="uRepairList" checkbox="true" pagination="true" fitColumns="true" title="" actionUrl="uRepairController.do?datagrid&status=${param.status}" sortName="applyDate" sortOrder="desc" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="用户ID"  field="userId" hidden="true" queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="当前节点"  field="createName"   queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="报修单号"  field="repairNum"   queryMode="single"  width="115"></t:dgCol>
      <t:dgCol title="报修人" field="userName"  queryMode="single"  width="70"></t:dgCol>
      <t:dgCol title="报修时间"  field="applyDate"  queryMode="single"  width="130"></t:dgCol>
      <t:dgCol title="流程状态"  field="status"  replace="创建_0,处理_1,完成_2,关闭_3" extendParams="styler:statetype" queryMode="single"  width="70"></t:dgCol>

   <t:dgCol title="报修方式"  field="bxType" dictionary="bxType"  queryMode="single"  width="70"></t:dgCol>
   <t:dgCol title="设备型号"  field="brand"  queryMode="single"  width="90"></t:dgCol>
      <t:dgCol title="设备名称"  field="proZnName"  queryMode="single"  width="100"></t:dgCol>
   ...
   <%--<t:dgCol title="备注"  field="remark"  queryMode="single"  width="120"></t:dgCol>--%>
      <t:dgFunOpt funname="goToProcess(id)" title="流程进度" urlclass="ace_button" urlfont="fa-tasks"></t:dgFunOpt>
      <t:dgFunOpt funname="doRecover(id,createName)" title="追回" exp="status#eq#1" urlclass="ace_button" urlStyle="background-color:#ec4758;" urlfont="fa-exchange"></t:dgFunOpt>
      <t:dgFunOpt funname="" title="改派" exp="status#eq#1" urlclass="ace_button" urlStyle="background-color:#18a689;" urlfont="fa-sign-out"></t:dgFunOpt>
      <t:dgFunOpt funname="endProcess(id)" exp="status#ne#3" title="关闭" urlclass="ace_button" urlStyle="background-color:#18a689;" urlfont="fa-close"></t:dgFunOpt>
