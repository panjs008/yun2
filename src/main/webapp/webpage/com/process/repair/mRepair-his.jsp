...
<head>
    ...
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_AllChecked.js"></script>
    ...
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Checkbox.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_ChooseList.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Codeval.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_CountDown.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_CountTo.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_DateTime.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Dialog.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_DropLoad.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_DropUpDown.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Favorite.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Form.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_GetVerifyCode.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_IntlTelInput.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Lazyload.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_lightSlider.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Loader.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_MultiDate.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_NowTime.js"></script>
    ...
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Radio.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Ratyli.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_ScrollFixed.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Select.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Slider.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_SnInput.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Spinner.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_StepOrder.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Substring.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Switch.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Tabs.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Textarea.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_TouchDelete.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_TouchSwipe.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Typeahead.js"></script>
    <script type="text/javascript" src="${webRoot}/andrew/js/plugin/Andrew_Validate.js"></script>
...
<main>
    ...
    <div class="module list press mt_5">
        <h3 class="bg_white c_title pl_3 line_h_36em bor_bottom bor_gray_ddd">时间轴</h3>
            ...
            <ul id="plug_photo_slider">
                <li class="h_8em">
                    <figure class="bg_gray_f5f border bor_gray_ddd h_in img_auto">
                        <img src="${webRoot}/andrew/img/tibet-1.jpg" />
                    </figure>
                </li>
                <li class="h_8em">
                    <figure class="bg_gray_f5f border bor_gray_ddd h_in img_auto">
                        <img src="${webRoot}/andrew/img/tibet-2.jpg" />
                    </figure>
                </li>
                <li class="h_8em">
                    <figure class="bg_gray_f5f border bor_gray_ddd h_in img_auto">
                        <img src="${webRoot}/andrew/img/tibet-3.jpg" />
                    </figure>
                </li>
                <li class="h_8em">
                    <figure class="bg_gray_f5f border bor_gray_ddd h_in img_auto">
                        <img src="${webRoot}/andrew/img/tibet-4.jpg" />
                    </figure>
                </li>
                <li class="h_8em">
                    <figure class="bg_gray_f5f border bor_gray_ddd h_in img_auto">
                        <img src="${webRoot}/andrew/img/tibet-5.jpg" />
                    </figure>
                </li>
                <li class="h_8em">
                    <figure class="bg_gray_f5f border bor_gray_ddd h_in img_auto">
                        <img src="${webRoot}/andrew/img/tibet-6.jpg" />
                    </figure>
                </li>
            </ul>
        </div>
        ...
        <ul class="plug_viewer lazyload ml_3 mt_1em length2">
            <li class="fl ovh h_8em mb_1em">
                <figure class="w_94 border bor_gray_ddd img_auto h_in">
                    <img data-original="${webRoot}/andrew/img/tibet-1.jpg" src="${webRoot}/andrew/img/thumbnails/tibet-1.jpg" alt="图片1" />
                </figure>
            </li>
            <li class="fl ovh h_8em mb_1em">
                <figure class="w_94 border bor_gray_ddd img_auto h_in">
                    <img data-original="${webRoot}/andrew/img/tibet-2.jpg" src="${webRoot}/andrew/img/thumbnails/tibet-2.jpg" alt="图片2" />
                </figure>
            </li>
            <li class="fl ovh h_8em mb_1em">
                <figure class="w_94 border bor_gray_ddd img_auto h_in">
                    <img data-original="${webRoot}/andrew/img/tibet-3.jpg" src="${webRoot}/andrew/img/thumbnails/tibet-3.jpg" alt="图片3" />
                </figure>
            </li>
            <li class="fl ovh h_8em mb_1em">
                <figure class="w_94 border bor_gray_ddd img_auto h_in">
                    <img data-original="${webRoot}/andrew/img/tibet-4.jpg" src="${webRoot}/andrew/img/thumbnails/tibet-4.jpg" alt="图片4" />
                </figure>
            </li>
            <li class="fl ovh h_8em mb_1em">
                <figure class="w_94 border bor_gray_ddd img_auto h_in">
                    <img data-original="${webRoot}/andrew/img/tibet-5.jpg" src="${webRoot}/andrew/img/thumbnails/tibet-5.jpg" alt="图片5" />
                </figure>
            </li>
            <li class="fl ovh h_8em mb_1em">
                <figure class="w_94 border bor_gray_ddd img_auto h_in">
                    <img data-original="${webRoot}/andrew/img/tibet-6.jpg" src="${webRoot}/andrew/img/thumbnails/tibet-6.jpg" alt="图片6" />
                </figure>
            </li>
        </ul>
    </div>
...
<footer class="press bg_gray_f9f">
    <menu class="bor_gray_ddd bor_top">
        ...
        <button type="button" class="fl" style="color:#79c34a !important" onclick="goto('uRepairController.do?mRepairHis')">
            <i class="text_18em c_gray_777"></i>
