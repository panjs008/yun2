...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="uRepairList" checkbox="true" pagination="true" fitColumns="true" title="" actionUrl="uRepairController.do?todaydatagrid" sortName="applyDate" sortOrder="desc" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
            ...
            <t:dgFunOpt funname="doRecover(id,createName)" title="追回" exp="status#eq#1,2,3" urlclass="ace_button" urlStyle="background-color:#ec4758;" urlfont="fa-exchange"></t:dgFunOpt>
            <t:dgFunOpt funname="endProcess(id)" exp="status#ne#5,4" title="关闭" urlclass="ace_button" urlStyle="background-color:#18a689;" urlfont="fa-close"></t:dgFunOpt>
