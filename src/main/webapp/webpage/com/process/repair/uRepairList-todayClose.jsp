...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="uRepairList" checkbox="true" pagination="true" fitColumns="true" title="" actionUrl="uRepairController.do?todaydatagrid&userId=${CUR_USER.userName}&status=5" sortName="applyDate" sortOrder="desc" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
