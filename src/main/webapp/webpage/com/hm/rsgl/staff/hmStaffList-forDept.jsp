...
<t:datagrid name="hmStaffList" checkbox="true" pagination="true"  sortOrder="asc" pageSize="20" fitColumns="false" title="" actionUrl="hmStaffController.do?datagrid&deptId=${param.departId}" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
