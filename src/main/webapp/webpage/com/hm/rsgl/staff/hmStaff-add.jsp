...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hmStaffController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="workNo" name="workNo" type="text" readonly style="width: 150px" class="inputxt"  ignore="ignore"  value='${workNo}'/>
		...
		<%--	<td align="right">
			...
			<td class="value">
				<select id="isSale" name="isSale" datatype="*">
