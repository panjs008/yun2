...
<div id="main_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="hmStaffYgdtMxList" checkbox="false" pagination="false"  sortOrder="asc" pageSize="20" fitColumns="false" title="" actionUrl="hmStaffController.do?listAllYgdtMxByJdbc&groupCode=${param.groupCode}&month=${param.month}" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
