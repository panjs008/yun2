...
<script>
    function formatDetail(val,row,index){
        if(val != null && val != ''  && val != '0.0' && val != '0'){
            var s = '<a href="javascript:detailReport(\''+row.month+'\')"><font color="blue">'+val+'</font></a>';
            return s;
        }else{
            return '';
        }
...
<div id="main_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="hmSalaryList" checkbox="false" pagination="true"  sortOrder="asc" pageSize="20" fitColumns="false" title="" actionUrl="hmSalaryController.do?listKfReportByJdbc&c=A01A02A08" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
...
<script type="text/javascript">
    ...
    function detailReport(month){
        ...
        $('#proDetialListpanel').panel("refresh", "hmSalaryController.do?forKfDetailReport&c=A01A02A08&month=" + month);
    }
