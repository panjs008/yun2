...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="hmSalaryList" checkbox="false"  sortName="deptName,workName,groupName" pageSize="20" pagination="true" fitColumns="false" title="" actionUrl="hmSalaryController.do?datagrid&leaveT=1&leaveT2=1" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
            ...
            <t:dgToolBar title="编辑" icon="fa fa-edit" url="hmSalaryController.do?goUpdate&winTitle=编辑工资表信息" funname="update" height="500"></t:dgToolBar>
            <t:dgToolBar title="打印自离工资总表" icon="fa fa-print" url="eEnsureUserController.do?goUpdate" funname="printPreview"></t:dgToolBar>
...
<script type="text/javascript">
    ...
    function printPreview(){
        ...
        openwindow("打印预览",'hmSalaryController.do?jump&r=qtPrintSheetFrm&url=hmSalaryController.do?printPreview&leaveT=1&month='+month,"hmSalaryList",width,height);
    }
