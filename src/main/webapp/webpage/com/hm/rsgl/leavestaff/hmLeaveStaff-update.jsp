...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#leaveType").val(${hmLeaveStaffPage.leaveType });
			$("#state").val(${hmLeaveStaffPage.state });
			$("#sex").val('${hmLeaveStaffPage.sex }');

		});
	</script>
</head>
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hmLeaveStaffController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" colspan="3">
				<input name="realName"   type="text"  value="${hmLeaveStaffPage.realName }" style="width: 150px"  id="realName"/>
				<input name="workNo"   type="hidden" value="${hmLeaveStaffPage.workNo }"   style="width: 150px"  id="workNo"/>
			...
			<td class="value">
				<input name="deptCode"   type="hidden"  value="${hmLeaveStaffPage.deptCode }"  id="deptCode"/>
				<input name="deptName"   type="text" value="${hmLeaveStaffPage.deptName }"  readonly  style="width: 150px"  id="deptName"/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input name="workCode"   type="hidden"  value="${hmLeaveStaffPage.workCode }"  id="workCode"/>
				<input name="workName"  style="width: 150px"  value="${hmLeaveStaffPage.workName }"  readonly type="text"  id="workName"/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input name="groupCode"   type="hidden"   value="${hmLeaveStaffPage.groupCode }" id="groupCode"/>
				<input name="groupName" style="width: 150px"    value="${hmLeaveStaffPage.groupName }" readonly  type="text"  id="groupName"/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<t:dictSelect id="job" field="job"  typeGroupCode="job"  defaultVal="${hmLeaveStaffPage.job }" hasLabel="false" title="职务"></t:dictSelect>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect id="jb" field="jb" typeGroupCode="jb"  defaultVal="${hmLeaveStaffPage.jb }" hasLabel="false" title="级别"></t:dictSelect>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<t:dictSelect id="xclb" field="xclb" typeGroupCode="xclb" defaultVal="${hmLeaveStaffPage.xclb }" hasLabel="false" title="薪酬类别"></t:dictSelect>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				...
				<%--<t:dictSelect id="sex" field="sex" typeGroupCode="sex"  defaultVal="${hmLeaveStaffPage.sex }" hasLabel="false" title="性别"></t:dictSelect>--%>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect id="yglb" field="yglb" typeGroupCode="yglb"   defaultVal="${hmLeaveStaffPage.yglb }" hasLabel="false" title="员工类别"></t:dictSelect>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<t:dictSelect id="taker" field="taker" typeGroupCode="dg"  defaultVal="${hmLeaveStaffPage.taker }" hasLabel="false" title="带工"></t:dictSelect>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<t:dictSelect id="workType" field="workType" typeGroupCode="gdls"  defaultVal="${hmLeaveStaffPage.workType }" hasLabel="false" title="性别"></t:dictSelect>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect id="zzmm" field="zzmm" typeGroupCode="zzmm" defaultVal="${hmLeaveStaffPage.zzmm }" hasLabel="false" title="政治面貌"></t:dictSelect>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect id="isNs" field="isNs" typeGroupCode="isNs" defaultVal="${hmLeaveStaffPage.isNs }" hasLabel="false" title="政治面貌"></t:dictSelect>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="applyDate" name="applyDate"  type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 150px" class="Wdate"  ignore="ignore"  value='${hmLeaveStaffPage.applyDate}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="annualDate" name="annualDate"  type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'leaveDate\');}'})" style="width: 150px" class="Wdate"  ignore="ignore"  value='${hmLeaveStaffPage.annualDate}'/>
				<span class="Validform_checktip"></span>
