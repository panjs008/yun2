...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hmBaseSalaryController.do?doAddChange" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				<input id="excetuDate" value="${kdDate}" readonly  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly name="excetuDate" type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				<textarea  id="reason"  style="width:95%;height:30px" class="inputxt" rows="3" name="reason"></textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				...
				<input id="fileName" name="fileName"  type="text" style="width: 150px;" readonly onclick="uploadClick('salaryFile')">
