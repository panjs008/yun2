...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" tiptype="1" layout="table" action="ymkCustomTraceController.do?doAdd" >
	  ...
	  <input id="cusId" name="cusId" type="hidden" value="${param.cusId}" />
					...
					<td class="value">
						<select class="form-control select2" id="cusName" name="cusName" datatype="*"  >
							<option value="">请选择客户</option>
					     	 ...
					     	 <%--<input id="cusName" name="cusName" type="text" style="width: 150px" value="${cusName}"  readonly class="inputxt"  ignore="ignore" />--%>
