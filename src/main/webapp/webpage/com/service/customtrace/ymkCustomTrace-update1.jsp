...
<html>
 <head>
  ...
  $(function(){
      ...
      $.ajax({
          url : "ymkCustomContactController.do?getContect&customId=${ymkCustomTracePage.cusId}",
          type : 'post',
          cache : false,
          data: null,
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" tiptype="1" layout="table" action="ymkCustomTraceController.do?doUpdate" >
			...
			<tr>
                ...
                <td class="value">
                    <input id="cusId" name="cusId" datatype="*" type="hidden" value="${ymkCustomTracePage.cusId}" />

                    <input class="easyui-combobox" name="customIdVal" value="${ymkCustomTracePage.cusName }"  style="width:150px;" data-options="
                    loader: myloader,
                    mode: 'remote',
                    valueField: 'id',
                    textField: 'name',
				...
				<td class="value">
					<select name="contactId" id="contactId" datatype="*">
