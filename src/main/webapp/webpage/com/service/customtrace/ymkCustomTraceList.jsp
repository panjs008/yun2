...
<t:datagrid name="ymkCustomTraceList" checkbox="true"  pagination="false" fitColumns="false" title="" actionUrl="ymkCustomTraceController.do?datagrid&cusId=${param.customId}" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
 ...
 <t:dgCol title="客户名称"  field="cusName"  queryMode="single"  width="250"></t:dgCol>
 ...
 <t:dgCol title="联系人"  field="contactName"  queryMode="single"  width="120"></t:dgCol>
 ...
 <t:dgToolBar title="录入" icon="fa fa-plus" url="ymkCustomTraceController.do?goAdd&cusId=${param.customId}" funname="add"></t:dgToolBar>
 <t:dgToolBar title="编辑" icon="fa fa-edit" url="ymkCustomTraceController.do?goUpdate" funname="update"></t:dgToolBar>
