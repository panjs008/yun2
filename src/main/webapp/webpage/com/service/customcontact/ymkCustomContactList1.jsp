...
<t:datagrid name="ymkCustomContactList" checkbox="true" title="" pagination="true" fitColumns="false"  actionUrl="ymkCustomContactController.do?datagrid&customId=${custom.id}" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
 <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
 <t:dgCol title="创建日期"  field="createDate"  formatter="yyyy-MM-dd"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
 <t:dgCol title="所属部门"  field="sysOrgCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
 <t:dgCol title="服务商名称"  field="customName" queryMode="single"  width="200"></t:dgCol>
 <t:dgCol title="用户账号"  field="createName"   queryMode="single" dictionary="t_s_base_user,id,username"   width="120"></t:dgCol>
