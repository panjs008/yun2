...
<t:datagrid name="ymkCustomContactList" checkbox="true" title="自用工程师" pagination="true" fitColumns="false"  actionUrl="ymkCustomContactController.do?datagrid&customId=${param.customId}" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
