...
<t:datagrid name="ymkCustomBankList" checkbox="true"  pagination="true" fitColumns="false" title="" actionUrl="ymkCustomBankController.do?datagrid&customId=${param.customId}" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
 ...
 <t:dgCol title="银行名称"  field="bankName"  queryMode="single"  width="150"></t:dgCol>
 ...
 <t:dgToolBar title="录入" icon="fa fa-plus" url="ymkCustomBankController.do?goAdd&customId=${param.customId}" funname="add"></t:dgToolBar>
 <t:dgToolBar title="编辑" icon="fa fa-edit" url="ymkCustomBankController.do?goUpdate" funname="update"></t:dgToolBar>
