...
<t:datagrid name="ymkCustomAlertList" checkbox="true"  pagination="true" fitColumns="false" title="" actionUrl="ymkCustomAlertController.do?datagrid" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
 ...
 <t:dgToolBar title="录入" icon="fa fa-plus" url="ymkCustomAlertController.do?goAdd1" funname="add"></t:dgToolBar>
 <t:dgToolBar title="编辑" icon="fa fa-edit" url="ymkCustomAlertController.do?goUpdate1" funname="update"></t:dgToolBar>
 <t:dgToolBar title="删除"  icon="fa fa-remove" url="ymkCustomAlertController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
