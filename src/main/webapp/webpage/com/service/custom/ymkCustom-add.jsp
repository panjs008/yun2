...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ymkCustomController.do?doAdd" tiptype="1">
	...
	<table style="width:100%;" cellpadding="0" cellspacing="1" class="formtable">
		<%--<tr>
			...
			<td class="value">
				<input id="daanNum" name="daanNum" readonly type="text" value="${daanNum}" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" width="35%">
				<input id="cusNum" name="cusNum" type="text" readonly style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="bcqkMoney" name="bcqkMoney" type="text"  datatype="d" value="0" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<t:dictSelect id="bz" field="bz" typeGroupCode="cointype"  defaultVal="${ymkCustomPage.bz }" hasLabel="false" title="币种"></t:dictSelect>
				<span class="Validform_checktip"></span>
