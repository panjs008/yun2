...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="departList" title="" fitColumns="true" pageSize="20" actionUrl="departController.do?departgrid" treegrid="true" idField="departid" btnCls="bootstrap" pagination="false">
            ...
            <t:dgToolBar title="录入" icon="fa fa-plus" url="" funname="addOrg"></t:dgToolBar>
            <t:dgToolBar title="编辑" icon="fa fa-edit" url="" funname="updateOrg"></t:dgToolBar>
            <t:dgToolBar title="导入" icon="fa fa-arrow-circle-left" funname="ImportDepartXls"></t:dgToolBar>
...
<!--
    ...
    function addOrg() {
        ...
        var url = "departController.do?add";

        add('<t:mutiLang langKey="common.add.param" langArg="common.department"/>', url, "departList","660px","480px");

    }
    function updateOrg() {
        var url = "departController.do?update";
        update('<t:mutiLang langKey="common.add.param" langArg="common.department"/>', url, "departList","660px","480px");

    }

    function queryUsersByDepart(id){
        ...
        $('#main_depart_list').layout('panel','east').panel('resize', {width: 660});
        var rowsData = $('#departList').datagrid('getSelections');
        $('#userListpanel').panel("refresh", "hmStaffController.do?forDept&departId=" + id);
    }
    /**
     * 为 组织机构 设置 角色
