...
<t:datagrid name="userList" width="100%" title="common.operation" actionUrl="userController.do?datagrid&userKey=业主管理员" fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" btnCls="bootstrap"  sortOrder="asc,desc">
