...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds" tiptype="1">
	<input id="id" name="id" type="hidden" value="${user.id }"/>
	<input id="storageId" name="storageId" type="hidden" value="${user.storageId }"/>
	<input id="storageName" name="storageName" type="hidden" value="${user.storageName }"/>
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
               ...
               <%-- <input id="departname" name="departname" type="text" readonly="readonly" class="inputxt" datatype="*" value="${departname}"/>
                ...
                <span class="Validform_checktip">部门</span>
            </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="value">
				<input type="hidden" name="devFlag" value="0"  />
