...
<t:datagrid name="userList0" checkbox="false" pagination="true" fitColumns="true" title="" width="100%" actionUrl="userController.do?servicedatagrid&userkey=设备中标商"
    ...
    <t:dgCol title="common.username" hidden="true" sortable="false" width="90" field="userName" ></t:dgCol>
