...
<div region="west" style="width: 200px;" title="组织机构" split="true">
...
<div region="center" style="padding:0px;border:0px">
	<t:datagrid name="userList" title="common.operation" actionUrl="userController.do?datagrid" fit="true" pageSize="20" fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" btnCls="bootstrap"  sortOrder="asc,desc">
		<t:dgCol title="common.id" field="id" hidden="true"></t:dgCol>
		<t:dgCol title="common.username" sortable="false" field="userName" query="true" width="80"></t:dgCol>
		...
		<t:dgCol title="仓库" field="storageName" width="80"></t:dgCol>

		<t:dgCol title="common.createby" field="createBy" hidden="true" width="120"></t:dgCol>
		<t:dgCol title="common.createtime" field="createDate" formatter="yyyy-MM-dd"  width="70" hidden="false"></t:dgCol>
		...
		<t:dgToolBar title="common.add.param" langArg="common.user" icon="fa fa-plus" url="userController.do?addorupdate" funname="add" height="420"></t:dgToolBar>
		<t:dgToolBar title="common.edit.param" langArg="common.user" icon="fa fa-edit" url="userController.do?addorupdate" funname="update"></t:dgToolBar>
		<t:dgToolBar title="common.password.reset" icon="fa fa-edit" url="userController.do?changepasswordforuser" funname="update"></t:dgToolBar>
		<t:dgToolBar title="common.lock.user" icon="fa fa-ban" url="userController.do?lock&lockvalue=0" funname="lockObj"></t:dgToolBar>
		<t:dgToolBar title="common.unlock.user" icon="fa fa-check-circle-o" url="userController.do?lock&lockvalue=1" funname="unlockObj"></t:dgToolBar>
...
<script>
    $(function() {
		...
		$('#orgtree').tree({
			...
			url : 'departController.do?setPFunction&selfId=${depart.orgCode}',
			onClick: function (node) {
				if ($('#orgtree').tree('isLeaf', node.target) || $('#orgtree').tree('expand', node.target)) {
					$('#userList').datagrid("reload", {"departid": node.id});
