...
<t:datagrid name="userList0" checkbox="false" pagination="true" fitColumns="true" title="" width="100%" actionUrl="userController.do?servicedatagrid&userkey=本地服务商"
             idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
            <t:dgCol title="common.id" field="id" hidden="true"></t:dgCol>
    <t:dgCol title="客户名称" sortable="false" width="150" field="cus_name" query="false"></t:dgCol>
    ...
    <t:dgCol title="common.username" hidden="true" sortable="false" width="90" field="userName" query="true"></t:dgCol>
