...
<t:datagrid name="operationList" title="operate.manage" checkbox="true" btnCls="bootstrap" actionUrl="functionController.do?opdategrid&functionId=${functionId}" idField="id">
...
<%--     <t:dgCol title="permission.name" field="TSFunction_functionName"></t:dgCol> --%>
	...
	<t:dgToolBar title="删除"  icon="fa fa-remove" url="functionController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
