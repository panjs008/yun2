...
<t:datagrid name="roleList" title="common.role.list" actionUrl="roleController.do?roleGrid" fitColumns="true" pageSize="15" idField="id" sortName="id" sortOrder="desc" queryMode="group" btnCls="bootstrap">
