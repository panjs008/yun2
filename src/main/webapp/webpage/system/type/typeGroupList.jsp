...
<div id="main_typegroup_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        ...
        idField="id" treegrid="false" pagination="true" pageSize="20"  sortOrder="desc" sortName="createDate" onLoadSuccess="loadSuccess" queryMode="group" btnCls="bootstrap btn btn-info btn-xs">
            ...
            <t:dgCol title="common.operation" field="opt" width="100"></t:dgCol>
            <t:dgDelOpt url="systemController.do?delTypeGroup&id={id}" operationCode="delete" title="common.delete" urlclass="ace_button" urlStyle="background-color:#ec4758;" urlfont="fa-trash-o"></t:dgDelOpt>
...
<script type="text/javascript">
    ...
    function queryTypeValue(typegroupid, typegroupname){
        ...
        $('#userListpanel').panel("refresh", "systemController.do?goTypeGrid&typegroupname="+typegroupname+"&typegroupid=" + typegroupid);
    }
