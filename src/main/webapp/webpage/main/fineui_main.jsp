...
<head>
	...
	<meta name="keywords" content="云进销存管理系统">
    <meta name="description" content="云进销存管理系统">
    <title>
		云进销存管理系统</title>
...
<body style="overflow-y:hidden;">
	...
	<div class="layout-admin" style="display: none" id="layoutId">
		...
		<header class="layout-header" >
			<span class="header-logo" style="font-size: 20px;"><img id="logoBtn" src="images/logo.jpg" style="width:55px;margin-left:10px; height: 55px;display:inline-block;border-radius:30px"/>&nbsp;&nbsp;${CUR_USER.currentDepart.departname}</span>
...
<%--
			...
			<li class="header-bar-nav personInfo">
				<a href="javascript:;" id="personInfo">
					<span>
						...
						<span>${ROLE.rolename},${CUR_USER.userName}</span>
						<i class="icon-font adminIcon" style="margin-right:5px;">&#xe607;</i>
					</span>
				</a>
		...
		<section class="layout-main">
			...
			<div class="layout-main-body" style="margin:0;overflow-y: hidden;">
				<iframe id="indexFrm" class="body-iframe" name="iframe0" width="100%" height="100%"
						src="loginController.do?fineuiHome" frameborder="0" data-id="home.html" seamless></iframe>
			</div>
		</section>
		<div class="footer" style="border-top:none;width:100%;position:absolute;bottom:6px;font-size: 12px; right:0px;font-family: 微软雅黑;">
			<div class="pull-right" style="text-align: center">&copy; 云进销存管理平台2.0&nbsp;&nbsp;&nbsp;&nbsp;
			</div>
		</div>
	</div>
	</div>
    ...
    function clearLocalstorage(){
		...
		function toggleLeftMenu(obj){
			if($('#toggleLeftMenu').hasClass("close")){
				...
				$("#logoBtn").css("marginLeft",10);
			}else{
				$(obj).attr("title","展开菜单").find("i").html("&#xe501;");
				$("#logoBtn").css("marginLeft",0);
			}
			$('#toggleLeftMenu').click();
		}
	</script>
