...
<head>
    ...
    <meta name="keywords" content="云进销存管理平台">
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                                <span><img src="images/logo.jpg" style="width:55px; height: 55px;display:inline-block;border-radius:20px"/></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="欢迎使用云进销存管理平台" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
        ...
        <div class="row J_mainContent" id="content-main" style="margin-left:-13px;">
            ...
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="emkApprovalController.do?list" frameborder="0" data-id="loginController.do?hplushome" seamless></iframe>
        </div>
