...
function add(title,addurl,gname,width,height) {
	gridname=gname;
	if(addurl.indexOf("winTitle")>0){
		title = addurl.substring(addurl.indexOf("winTitle")+9);
	}
...
function update(title,url, id,width,height,isRestful) {
	...
	if(url.indexOf("winTitle")>0){
		title = url.substring(url.indexOf("winTitle")+9);
	}
...
function createdetailwindow(title, addurl,width,height) {
	...
	if(addurl.indexOf('emkEnquiryController.do?goAdd')>=0 || addurl.indexOf('emkEnquiryController.do?goUpdate')>=0){
		height =window.top.document.body.offsetHeight-100;
	}
	if(addurl.indexOf('emkProductController.do?goAdd')>=0 || addurl.indexOf('emkProductController.do?goUpdate')>=0){
		height =window.top.document.body.offsetHeight-100;
	}
	if(addurl.indexOf('emkFormaterialController.do?goAdd')>=0 || addurl.indexOf('emkFormaterialController.do?goUpdate')>=0){
		height =window.top.document.body.offsetHeight-100;
	}
	if(addurl.indexOf('emkFormaterialOtherController.do?goAdd')>=0 || addurl.indexOf('emkFormaterialOtherController.do?goUpdate')>=0){
		height =window.top.document.body.offsetHeight-100;
	}
	if(addurl.indexOf('emkOutOrderController.do?goAdd')>=0 || addurl.indexOf('emkOutOrderController.do?goUpdate')>=0){
		height =window.top.document.body.offsetHeight-100;
	}
	if(addurl.indexOf('emkPayController.do?goAdd')>=0 || addurl.indexOf('emkPayController.do?goUpdate')>=0){
		height =window.top.document.body.offsetHeight-100;
	}
	if(addurl.indexOf('emkStorageConnactController.do?list')>=0){
		width = window.top.document.body.offsetWidth;
		height =window.top.document.body.offsetHeight-100;
	}
	if(addurl.indexOf('emkMInStorageController.do?goAdd')>=0 || addurl.indexOf('emkMInStorageController.do?goUpdate')>=0 ||
		addurl.indexOf('emkMOutStorageController.do?goAdd')>=0 || addurl.indexOf('emkMOutStorageController.do?goUpdate')>=0 ||
		addurl.indexOf('emkProOrderController.do?goAdd')>=0 || addurl.indexOf('emkProOrderController.do?goUpdate')>=0 ||
		addurl.indexOf('emkCancelOrderController.do?goAdd')>=0 || addurl.indexOf('emkCancelOrderController.do?goUpdate')>=0 ||
		addurl.indexOf('emkOfferPriceController.do?goAdd')>=0 || addurl.indexOf('emkOfferPriceController.do?goUpdate')>=0 ||
		addurl.indexOf('emkStorageConnactController.do?goAdd')>=0 || addurl.indexOf('emkStorageConnactController.do?goUpdate')>=0){
		height =window.top.document.body.offsetHeight-100;
		width = window.top.document.body.offsetWidth-200;
	}
	if(addurl.indexOf('com/emk/bound/minstorage/emkMInStorage-process')>=0 || addurl.indexOf('com/emk/bound/moutstorage/emkMOutStorage-process')>=0){
		height =window.top.document.body.offsetHeight-100;
		width = window.top.document.body.offsetWidth-200;
		addurl = addurl + "&hVal="+(window.top.document.body.offsetHeight-140)+"px&hVal2="+(window.top.document.body.offsetHeight-180)+"px";
	}

	if(addurl.indexOf('com/emk/storage/enquiry/emkEnquiry-process')>=0){
		height =window.top.document.body.offsetHeight-100;
		//addurl = addurl +  "&hVal="+(window.top.document.body.offsetHeight-190)+"px&hVal2="+(window.top.document.body.offsetHeight-230)+"px";
		addurl = addurl + "&hVal="+(window.top.document.body.offsetHeight-140)+"px&hVal2="+(window.top.document.body.offsetHeight-180)+"px";
	}
	...
	if(addurl.indexOf('emkPriceController.do?goAdd')>=0 || addurl.indexOf('emkPriceController.do?goUpdate')>=0
		...
		if(typeof(windowapi) == 'undefined'){
			$.dialog({
				...
				cancelVal: '关闭',
				cancel: function(){
					/*if(addurl.indexOf('emkMInStorageController.do?goAdd2')>=0 || addurl.indexOf('emkMInStorageController.do?goUpdate2')>=0){
						$.ajax({
							url : "emkProOrderController.do?setOrderSession",
							type : 'post',
							cache : false,
							success : function(data) {
								var d = $.parseJSON(data);
