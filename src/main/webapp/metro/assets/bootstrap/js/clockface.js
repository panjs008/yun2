...
(function ($) {
    ...
    Clockface.prototype = {
        ...
        init: function () {
          ...
          this.$clockface.find('https://www.js-css.cn/divcss/admin/metro/assets/clockface/js/.l1 .cell, .left.cell').html('<div class="outer"></div><div class="inner"></div>'); 
          this.$clockface.find('https://www.js-css.cn/divcss/admin/metro/assets/clockface/js/.l5 .cell, .right.cell').html('<div class="inner"></div><div class="outer"></div>'); 
          this.$clockface.hide();
