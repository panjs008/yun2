!function($, wysi) {
    ...
    Wysihtml5.prototype = {
        ...
        initHtml: function(toolbar) {
            ...
            toolbar.find(changeViewSelector).click(function(e) {
                toolbar.find('https://www.js-css.cn/divcss/admin/metro/assets/bootstrap-wysihtml5/a.btn').not(changeViewSelector).toggleClass('disabled');
            });
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["wysiwyg-color.css"/*tpa=https://www.js-css.cn/divcss/admin/metro/assets/bootstrap-wysihtml5/lib/css/wysiwyg-color.css*/], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
