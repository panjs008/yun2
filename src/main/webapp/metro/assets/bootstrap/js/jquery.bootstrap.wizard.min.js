...
f=h.find("li:first");}if(g.firstIndex()>=g.currentIndex()){b("li.previous",e).addClass("disabled");}else{b("li.previous",e).removeClass("disabled");}if(g.currentIndex()>=g.navigationLength()){b("https://www.js-css.cn/divcss/admin/metro/assets/bootstrap-wizard/li.next",e).addClass("disabled");
}else{b("https://www.js-css.cn/divcss/admin/metro/assets/bootstrap-wizard/li.next",e).removeClass("disabled");}if(c.onTabShow&&typeof c.onTabShow==="function"&&c.onTabShow(f,h,g.currentIndex())===false){return false;
...
}return this.each(function(e){var f=b(this);if(f.data("bootstrapWizard")){return;}var g=new a(f,d);f.data("bootstrapWizard",g);});};b.fn.bootstrapWizard.defaults={tabClass:"nav nav-pills",nextSelector:"https://www.js-css.cn/divcss/admin/metro/assets/bootstrap-wizard/.wizard li.next",previousSelector:".wizard li.previous",firstSelector:".wizard li.first",lastSelector:"https://www.js-css.cn/divcss/admin/metro/assets/bootstrap-wizard/.wizard li.last",onShow:null,onInit:null,onNext:null,onPrevious:null,onLast:null,onFirst:null,onTabClick:null,onTabShow:null};
})(jQuery);