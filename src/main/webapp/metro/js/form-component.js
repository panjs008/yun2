var Script = function () {
    ...
    $(function() {
        ...
        //			$('https://www.js-css.cn/divcss/admin/metro/js/input.tags').tagsInput({onAddTag:onAddTag,onRemoveTag:onRemoveTag,onChange: onChangeTag});

        // Uncomment this line to see an input with no interface for adding new tags.
        //			$('https://www.js-css.cn/divcss/admin/metro/js/input.tags').tagsInput({interactive:false});
    });
