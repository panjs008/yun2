...
(function (factory) {
	...
	$.extend(Plugin.prototype, {
		...
		_construct: function(){
			...
			this.dis = this.$el.attr('disabled');
			if(this.dis){
                this.settings.Dselected = true;
			}
			 ...
			 * Append Input
			 */
			if(this.settings.Dselected){
                this.$input = $('<input disabled="disabled" type="text"' + (isMobile? 'tabindex="-1"': '') + ' placeholder="'+p+'" class="'+ this.settings.inputClass + '">').appendTo(this.$container)
            }else{
