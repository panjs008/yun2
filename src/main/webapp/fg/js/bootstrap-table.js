    ...
    var constants = {
      3: {
        ...
        html: {
          ...
          paginationInput: '<li class="page-input"><input type="text"></li>',
          paginationJump: '<li class="page-jump"><button>Go</button></li>',
          icon: '<i class="%s %s"></i>'
        }
      },
      4: {
    ...
    var BootstrapTable = function () {
      ...
      _createClass(BootstrapTable, [{
        ...
        value: function initPagination() {
          ...
          var nowPageSize=o.pageNumber*o.pageSize;
          if(nowPageSize>o.totalRows){
              nowPageSize=o.totalRows;
          }
          html.push('<div class="' + this.constants.classes.pull + '-' + o.paginationDetailHAlign + ' pagination-detail">\n        <span class="pagination-info"><span class="nowPageSize">'+nowPageSize+'</span>/' + paginationInfo + '\n        </span>');
          ...
          if (!o.onlyInfoPagination) {
            ...
            html.push(Utils.sprintf(this.constants.html.paginationItem, ' page-next', '下一页'+o.paginationNextText));
            html.push(Utils.sprintf(this.constants.html.paginationItem, ' page-last', '末页'));
            html.push(Utils.sprintf(this.constants.html.paginationInput));
            html.push(Utils.sprintf(this.constants.html.paginationJump));
          ...
          if (!o.onlyInfoPagination) {
            ...
            $jump = this.$pagination.find('.page-jump');
            $number = this.$pagination.find('.page-item').not('.page-next, .page-pre , .page-last, .page-first');
            ...
            $first.off('click').on('click', function (e) {
              return _this6.onPageFirst(e);
            });
            $last.off('click').on('click', function (e) {
                  return _this6.onPageLast(e);
            });
            $jump.off('click').on('click', function (e) {
                  return _this6.onPageJump(e);
            });
        ...
        value: function onPageListChange(event) {
          ...
          key: 'onPageFirst',
          value: function onPageFirst(event) {
              event.preventDefault();
              this.options.pageNumber=1;
              this.updatePagination(event);
              return false;
        ...
        {
            key: 'onPageJump',
                value: function onPageJump(event) {
            event.preventDefault();
            var jumpPage=Number(($(event.target).parent().siblings('.page-input').children('input').val()).trim());
            if(jumpPage && jumpPage<=this.options.totalPages){
                this.options.pageNumber=jumpPage;
                this.updatePagination(event);
            }else{
              return
            }
          ...
          key: 'onPageLast',
          value: function onPageLast(event) {
              event.preventDefault();
