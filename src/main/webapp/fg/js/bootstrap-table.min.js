...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function() {
        ...
        this.pageTo > this.options.totalRows && (this.pageTo = this.options.totalRows),
            m.push('<div class="pull-' + this.options.paginationDetailHAlign + ' pagination-detail">', '<span class="pagination-info page-first">', "首页", "</span><span class='pagination-info page-pre'>上一页</span><span class='pagination-info page-next'>下一页</span><span class='pagination-info page-last'>尾页</span>"),
        ...
        for ($.each(r,
            function(a, b) {
                if (!l.options.smartDisplay || 0 === a || r[a - 1] <= l.options.totalRows) {
                 ...
                 m.push("</span>"),
                 m.push("</div>", '<div class="pull-' + this.options.paginationHAlign + '">', '<span class="jump-to">跳转至</span><ul class="pagination' + (void 0 === this.options.iconSize ? "": " pagination-" + this.options.iconSize) + '">'),
        ...
        n && (this.options.pageSize = this.options.formatAllRows()),
            e.off("click").on("click", $.proxy(this.onPageListChange, this)),
            f.off("click").on("click", $.proxy(this.onPageFirst, this)),
            h.off("click").on("click", $.proxy(this.onPagePre, this)),
            i.off("click").on("click", $.proxy(this.onPageNext, this)),
            j.off("click").on("click", $.proxy(this.onPageLast, this)),
            k.off("click").on("click", $.proxy(this.onPageNumber, this));
    ...
    BootstrapTable.prototype.fitFooter = function () {
        ...
        this.$body.find('>tr:first-child:not(.no-records-found) > *').each(function (i) {
            ...
            $footerTd.eq(i).find('.fht-cell').width($this.innerWidth()-20);
        });
    };
