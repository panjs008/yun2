...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      //actions
      header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '      <div class="sc-yleft" style="display: none">' + '        &lsaquo;</div>' + '      <select class="sc-select-year" name="">' + '      </select>' + '      <div class="sc-yright" style="display: none">&rsaquo;</div>' + '  </div>';
      header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '    <div class="sc-mleft sc-mright-top">' + '</div>' + '    <select class="sc-select-month" name="">' + '    </select>' + '    <div class="sc-mright sc-mright-bottom"></div>' + '</div>';
      header.innerHTML = header.innerHTML + '<div class="sc-actions" style="display: none"><span class="sc-return-today ">返回今天</span></div>';
      header.innerHTML = header.innerHTML + '<div class="sc-actions" style="display: none"><span class="sc-time"></span></div>';
